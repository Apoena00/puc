...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_usuario' + iSeqRow).bind('blur', function() { sc_app_Login_usuario_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_app_Login_usuario_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_app_Login_usuario_onblur(oThis, iSeqRow) {
  do_ajax_app_Login_mob_validate_usuario();
  scCssBlur(oThis);
}

function sc_app_Login_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
