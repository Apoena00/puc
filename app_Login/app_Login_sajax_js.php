...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usuario
  function do_ajax_app_Login_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldHidden(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_validate_usuario(var_usuario, var_script_case_init, do_ajax_app_Login_validate_usuario_cb);
  } // do_ajax_app_Login_validate_usuario

  function do_ajax_app_Login_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_usuario_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_submit_form(var_login, var_pswd, var_usuario, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_submit_form_cb);
