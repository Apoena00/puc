...
<?php } else { ?>
<span id="id_read_on_old_pswd" class="sc-ui-readonly-old_pswd css_old_pswd_line" style="<?php echo $sStyleReadLab_old_pswd; ?>"><?php echo $this->form_encode_input($this->old_pswd); ?></span><span id="id_read_off_old_pswd" class="css_read_off_old_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_old_pswd; ?>"><input class="sc-js-input scFormObjectOdd css_old_pswd_obj" style="" id="id_sc_field_old_pswd" type=password autocomplete="off" name="old_pswd" value="" 
