...
<?php } else { ?>
<span id="id_read_on_name" class="sc-ui-readonly-name css_name_line" style="<?php echo $sStyleReadLab_name; ?>"><?php echo $this->form_encode_input($this->name); ?></span><span id="id_read_off_name" class="css_read_off_name" style="white-space: nowrap;<?php echo $sStyleReadInp_name; ?>">
