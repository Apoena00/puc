<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_perfil']          = "tcc_puc";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
          ob_start();
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt"));
           if (isset($apl_def[0]) && $apl_def[0] != "app_grid_sec_groups") {
           ...
           if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
               $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_groups']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
               $_SESSION['scriptcase']['app_grid_sec_groups']['session_timeout']['lang'] = $lang_atu;
           }
       }
   }
