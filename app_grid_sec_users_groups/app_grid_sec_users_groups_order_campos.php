...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['app_grid_sec_users_groups']['labels']["name"] : "" . $this->Nm_lang['lang_sec_users_fild_name'] . "";
