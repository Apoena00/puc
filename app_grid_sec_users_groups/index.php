<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_perfil']          = "tcc_puc";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users_groups']['conf_chart_level'] = "N";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt"));
           if (isset($apl_def[0]) && $apl_def[0] != "app_grid_sec_users_groups") {
           ...
           if (is_file($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
               $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['app_grid_sec_users_groups']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
               $_SESSION['scriptcase']['app_grid_sec_users_groups']['session_timeout']['lang'] = $lang_atu;
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['app_grid_sec_users_groups']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['app_grid_sec_users_groups']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetBlue/Sc9_SweetBlue";
...
// 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['app_grid_sec_users_groups']['opc_psq'] && !isset($_SESSION['scriptcase']['app_grid_sec_users_groups']['session_timeout']['redir'])) 
       { 
