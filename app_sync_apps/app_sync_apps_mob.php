...
//
   ...
   $_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_perfil']          = "tcc_puc";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_sync_apps_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc', 1, true);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        if (is_file($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt"));
            if (isset($apl_def[0]) && $apl_def[0] != "app_sync_apps") {
            ...
            if (is_file($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
                $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['app_sync_apps']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
                $_SESSION['scriptcase']['app_sync_apps']['session_timeout']['lang'] = $lang_atu;
            }
        }
    }
