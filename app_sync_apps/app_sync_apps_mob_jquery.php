...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_check_deleted' + iSeqRow).bind('blur', function() { sc_app_sync_apps_check_deleted_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_app_sync_apps_check_deleted_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_app_sync_apps_check_deleted_onblur(oThis, iSeqRow) {
  do_ajax_app_sync_apps_mob_validate_check_deleted();
  scCssBlur(oThis);
}

function sc_app_sync_apps_check_deleted_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
