...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_app_sync_apps_validate_check_deleted()
  {
    var nomeCampo_check_deleted = "check_deleted";
    var var_check_deleted = scAjaxGetFieldCheckbox(nomeCampo_check_deleted, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_sync_apps_validate_check_deleted(var_check_deleted, var_script_case_init, do_ajax_app_sync_apps_validate_check_deleted_cb);
  } // do_ajax_app_sync_apps_validate_check_deleted

  function do_ajax_app_sync_apps_validate_check_deleted_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_sync_apps_validate_check_deleted_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_app_sync_apps_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_sync_apps_submit_form(var_sync, var_check_deleted, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_sync_apps_submit_form_cb);
