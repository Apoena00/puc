...
//
   ...
   $_SESSION['scriptcase']['app_sync_apps']['glo_nm_perfil']          = "tcc_puc";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_sync_apps']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_sync_apps']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_sync_apps']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_sync_apps']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc', 1, true);
    }
    else {
