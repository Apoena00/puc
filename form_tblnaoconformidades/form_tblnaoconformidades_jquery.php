...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dtaidentificacao_hora' + iSeqRow).bind('blur', function() { sc_form_tblnaoconformidades_dtaidentificacao_hora_onblur(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_tblnaoconformidades_dtaidentificacao_hora_onfocus(this, iSeqRow) });
...
function sc_form_tblnaoconformidades_dtaidentificacao_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tblnaoconformidades_validate_dtaidentificacao();
  scCssBlur(oThis);
}
...
function sc_form_tblnaoconformidades_dtaidentificacao_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_veiculos(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tblncveiculos")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tblncveiculos")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_pecas(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_tblncpecas")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_tblncpecas")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_tblnaoconformidades_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dtaidentificacao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tblnaoconformidades_validate_dtaidentificacao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
