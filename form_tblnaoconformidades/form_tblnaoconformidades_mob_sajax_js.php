  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblnaoconformidades_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate intnaoconformidadeid
  function do_ajax_form_tblnaoconformidades_mob_validate_intnaoconformidadeid()
  {
    var nomeCampo_intnaoconformidadeid = "intnaoconformidadeid";
    var var_intnaoconformidadeid = scAjaxGetFieldHidden(nomeCampo_intnaoconformidadeid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_intnaoconformidadeid(var_intnaoconformidadeid, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_intnaoconformidadeid_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_intnaoconformidadeid

  function do_ajax_form_tblnaoconformidades_mob_validate_intnaoconformidadeid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intnaoconformidadeid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_intnaoconformidadeid_cb

  // ---------- Validate dtaidentificacao
  function do_ajax_form_tblnaoconformidades_mob_validate_dtaidentificacao()
  {
    var nomeCampo_dtaidentificacao = "dtaidentificacao";
    var var_dtaidentificacao = scAjaxGetFieldText(nomeCampo_dtaidentificacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_dtaidentificacao(var_dtaidentificacao, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_dtaidentificacao_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_dtaidentificacao

  function do_ajax_form_tblnaoconformidades_mob_validate_dtaidentificacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtaidentificacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_dtaidentificacao_cb

  // ---------- Validate strnaoconformidade
  function do_ajax_form_tblnaoconformidades_mob_validate_strnaoconformidade()
  {
    var nomeCampo_strnaoconformidade = "strnaoconformidade";
    var var_strnaoconformidade = scAjaxGetFieldText(nomeCampo_strnaoconformidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_strnaoconformidade(var_strnaoconformidade, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_strnaoconformidade_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_strnaoconformidade

  function do_ajax_form_tblnaoconformidades_mob_validate_strnaoconformidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strnaoconformidade";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_strnaoconformidade_cb

  // ---------- Validate strdescricao
  function do_ajax_form_tblnaoconformidades_mob_validate_strdescricao()
  {
    var nomeCampo_strdescricao = "strdescricao";
    var var_strdescricao = scAjaxGetFieldEditorHtml(nomeCampo_strdescricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_strdescricao(var_strdescricao, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_strdescricao_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_strdescricao

  function do_ajax_form_tblnaoconformidades_mob_validate_strdescricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strdescricao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_strdescricao_cb

  // ---------- Validate strnorma
  function do_ajax_form_tblnaoconformidades_mob_validate_strnorma()
  {
    var nomeCampo_strnorma = "strnorma";
    var var_strnorma = scAjaxGetFieldText(nomeCampo_strnorma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_strnorma(var_strnorma, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_strnorma_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_strnorma

  function do_ajax_form_tblnaoconformidades_mob_validate_strnorma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strnorma";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_strnorma_cb

  // ---------- Validate intstatusncid
  function do_ajax_form_tblnaoconformidades_mob_validate_intstatusncid()
  {
    var nomeCampo_intstatusncid = "intstatusncid";
    var var_intstatusncid = scAjaxGetFieldSelect(nomeCampo_intstatusncid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_intstatusncid(var_intstatusncid, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_intstatusncid_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_intstatusncid

  function do_ajax_form_tblnaoconformidades_mob_validate_intstatusncid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intstatusncid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_intstatusncid_cb

  // ---------- Validate veiculos
  function do_ajax_form_tblnaoconformidades_mob_validate_veiculos()
  {
    var nomeCampo_veiculos = "veiculos";
    var var_veiculos = scAjaxGetFieldText(nomeCampo_veiculos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_veiculos(var_veiculos, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_veiculos_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_veiculos

  function do_ajax_form_tblnaoconformidades_mob_validate_veiculos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "veiculos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_veiculos_cb

  // ---------- Validate pecas
  function do_ajax_form_tblnaoconformidades_mob_validate_pecas()
  {
    var nomeCampo_pecas = "pecas";
    var var_pecas = scAjaxGetFieldText(nomeCampo_pecas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_mob_validate_pecas(var_pecas, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_validate_pecas_cb);
  } // do_ajax_form_tblnaoconformidades_mob_validate_pecas

  function do_ajax_form_tblnaoconformidades_mob_validate_pecas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pecas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_mob_validate_pecas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblnaoconformidades_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblnaoconformidades_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intnaoconformidadeid = scAjaxGetFieldHidden("intnaoconformidadeid");
    var var_dtaidentificacao = scAjaxGetFieldText("dtaidentificacao");
    var var_strnaoconformidade = scAjaxGetFieldText("strnaoconformidade");
    var var_strdescricao = scAjaxGetFieldEditorHtml("strdescricao");
    var var_strnorma = scAjaxGetFieldText("strnorma");
    var var_intstatusncid = scAjaxGetFieldSelect("intstatusncid");
    ...
    scAjaxProcOn();
    x_ajax_form_tblnaoconformidades_mob_submit_form(var_intnaoconformidadeid, var_dtaidentificacao, var_strnaoconformidade, var_strdescricao, var_strnorma, var_intstatusncid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblnaoconformidades_mob_submit_form_cb);
  } // do_ajax_form_tblnaoconformidades_mob_submit_form

  function do_ajax_form_tblnaoconformidades_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("intnaoconformidadeid");
      scAjaxHideErrorDisplay("dtaidentificacao");
      scAjaxHideErrorDisplay("strnaoconformidade");
      scAjaxHideErrorDisplay("strdescricao");
      scAjaxHideErrorDisplay("strnorma");
      scAjaxHideErrorDisplay("intstatusncid");
      scAjaxHideErrorDisplay("veiculos");
      scAjaxHideErrorDisplay("pecas");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblnaoconformidades_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblnaoconformidades_mob_submit_form_cb
  function do_ajax_form_tblnaoconformidades_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblnaoconformidades_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tblncveiculos_mob"] = "off";
  scStatusDetail["form_tblncpecas_mob"] = "off";

  function do_ajax_form_tblnaoconformidades_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("veiculos");
    scAjaxHideErrorDisplay("pecas");
    var var_intnaoconformidadeid = document.F2.intnaoconformidadeid.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tblncveiculos_mob"] = "on";
    scStatusDetail["form_tblncpecas_mob"] = "on";
    x_ajax_form_tblnaoconformidades_mob_navigate_form(var_intnaoconformidadeid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblnaoconformidades_mob_navigate_form_cb);
  } // do_ajax_form_tblnaoconformidades_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblnaoconformidades_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblnaoconformidades_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblnaoconformidades_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.intnaoconformidadeid.value = scAjaxGetKeyValue("intnaoconformidadeid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblncveiculos_mob"] && "nmsc_iframe_liga_form_tblncveiculos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tblncveiculos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblncveiculos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblncveiculos_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tblncveiculos_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tblncveiculos_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblncpecas_mob"] && "nmsc_iframe_liga_form_tblncpecas_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tblncpecas_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblncpecas_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblncpecas_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tblncpecas_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tblncpecas_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblnaoconformidades_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblnaoconformidades_mob_navigate_form_cb
  function do_ajax_form_tblnaoconformidades_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblnaoconformidades_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblnaoconformidades_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblnaoconformidades_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tblncveiculos_mob"] && "off" == scStatusDetail["form_tblncpecas_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "intnaoconformidadeid";
  ajax_field_list[1] = "dtaidentificacao";
  ajax_field_list[2] = "strnaoconformidade";
  ajax_field_list[3] = "strdescricao";
  ajax_field_list[4] = "strnorma";
  ajax_field_list[5] = "intstatusncid";
  ajax_field_list[6] = "veiculos";
  ajax_field_list[7] = "pecas";
  ...
  var ajax_error_list = {
    "intnaoconformidadeid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnaoconformidades_fld_intnaoconformidadeid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtaidentificacao": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnaoconformidades_fld_dtaidentificacao'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strnaoconformidade": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnaoconformidades_fld_strnaoconformidade'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strdescricao": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnaoconformidades_fld_strdescricao'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strnorma": {"label": "URL Norma", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intstatusncid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnaoconformidades_fld_intstatusncid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "veiculos": {"label": "Veículos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pecas": {"label": "Peças", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "intnaoconformidadeid": new Array(),
    "dtaidentificacao": new Array(),
    "strnaoconformidade": new Array(),
    "strdescricao": new Array(),
    "strnorma": new Array(),
    "intstatusncid": new Array(),
    "veiculos": new Array(),
    "pecas": new Array()
  };
  ajax_field_mult["intnaoconformidadeid"][1] = "intnaoconformidadeid";
  ajax_field_mult["dtaidentificacao"][1] = "dtaidentificacao";
  ajax_field_mult["strnaoconformidade"][1] = "strnaoconformidade";
  ajax_field_mult["strdescricao"][1] = "strdescricao";
  ajax_field_mult["strnorma"][1] = "strnorma";
  ajax_field_mult["intstatusncid"][1] = "intstatusncid";
  ajax_field_mult["veiculos"][1] = "veiculos";
  ajax_field_mult["pecas"][1] = "pecas";

  var ajax_field_id = {
    "intnaoconformidadeid": new Array("hidden_field_label_intnaoconformidadeid", "hidden_field_data_intnaoconformidadeid"),
    "dtaidentificacao": new Array("hidden_field_label_dtaidentificacao", "hidden_field_data_dtaidentificacao"),
    "strnaoconformidade": new Array("hidden_field_label_strnaoconformidade", "hidden_field_data_strnaoconformidade"),
    "strdescricao": new Array("hidden_field_label_strdescricao", "hidden_field_data_strdescricao"),
    "strnorma": new Array("hidden_field_label_strnorma", "hidden_field_data_strnorma"),
    "intstatusncid": new Array("hidden_field_label_intstatusncid", "hidden_field_data_intstatusncid"),
    "veiculos": new Array("hidden_field_label_veiculos", "hidden_field_data_veiculos"),
    "pecas": new Array("hidden_field_label_pecas", "hidden_field_data_pecas")
  };

  var ajax_read_only = {
    "intnaoconformidadeid": "on",
    "dtaidentificacao": "off",
    "strnaoconformidade": "off",
    "strdescricao": "off",
    "strnorma": "off",
    "intstatusncid": "off",
    "veiculos": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("intnaoconformidadeid" == sIndex)
    {
