  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblnaoconformidades" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblnaoconformidades_validate_intnaoconformidadeid()
  {
    ...
    x_ajax_form_tblnaoconformidades_validate_intnaoconformidadeid(var_intnaoconformidadeid, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_intnaoconformidadeid_cb);
  } // do_ajax_form_tblnaoconformidades_validate_intnaoconformidadeid

  function do_ajax_form_tblnaoconformidades_validate_intnaoconformidadeid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_intnaoconformidadeid_cb

  // ---------- Validate dtaidentificacao
  function do_ajax_form_tblnaoconformidades_validate_dtaidentificacao()
  {
    var nomeCampo_dtaidentificacao = "dtaidentificacao";
    var var_dtaidentificacao = scAjaxGetFieldText(nomeCampo_dtaidentificacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_dtaidentificacao(var_dtaidentificacao, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_dtaidentificacao_cb);
  } // do_ajax_form_tblnaoconformidades_validate_dtaidentificacao

  function do_ajax_form_tblnaoconformidades_validate_dtaidentificacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_dtaidentificacao_cb

  // ---------- Validate strnaoconformidade
  function do_ajax_form_tblnaoconformidades_validate_strnaoconformidade()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_strnaoconformidade(var_strnaoconformidade, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_strnaoconformidade_cb);
  } // do_ajax_form_tblnaoconformidades_validate_strnaoconformidade

  function do_ajax_form_tblnaoconformidades_validate_strnaoconformidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_strnaoconformidade_cb

  // ---------- Validate strdescricao
  function do_ajax_form_tblnaoconformidades_validate_strdescricao()
  {
    var nomeCampo_strdescricao = "strdescricao";
    var var_strdescricao = scAjaxGetFieldEditorHtml(nomeCampo_strdescricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_strdescricao(var_strdescricao, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_strdescricao_cb);
  } // do_ajax_form_tblnaoconformidades_validate_strdescricao

  function do_ajax_form_tblnaoconformidades_validate_strdescricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_strdescricao_cb

  // ---------- Validate strnorma
  function do_ajax_form_tblnaoconformidades_validate_strnorma()
  {
    var nomeCampo_strnorma = "strnorma";
    var var_strnorma = scAjaxGetFieldText(nomeCampo_strnorma);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_strnorma(var_strnorma, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_strnorma_cb);
  } // do_ajax_form_tblnaoconformidades_validate_strnorma

  function do_ajax_form_tblnaoconformidades_validate_strnorma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_strnorma_cb

  // ---------- Validate intstatusncid
  function do_ajax_form_tblnaoconformidades_validate_intstatusncid()
  {
    var nomeCampo_intstatusncid = "intstatusncid";
    var var_intstatusncid = scAjaxGetFieldSelect(nomeCampo_intstatusncid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_intstatusncid(var_intstatusncid, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_intstatusncid_cb);
  } // do_ajax_form_tblnaoconformidades_validate_intstatusncid

  function do_ajax_form_tblnaoconformidades_validate_intstatusncid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_intstatusncid_cb

  // ---------- Validate veiculos
  function do_ajax_form_tblnaoconformidades_validate_veiculos()
  {
    var nomeCampo_veiculos = "veiculos";
    var var_veiculos = scAjaxGetFieldText(nomeCampo_veiculos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_veiculos(var_veiculos, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_veiculos_cb);
  } // do_ajax_form_tblnaoconformidades_validate_veiculos

  function do_ajax_form_tblnaoconformidades_validate_veiculos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_veiculos_cb

  // ---------- Validate pecas
  function do_ajax_form_tblnaoconformidades_validate_pecas()
  {
    var nomeCampo_pecas = "pecas";
    var var_pecas = scAjaxGetFieldText(nomeCampo_pecas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnaoconformidades_validate_pecas(var_pecas, var_script_case_init, do_ajax_form_tblnaoconformidades_validate_pecas_cb);
  } // do_ajax_form_tblnaoconformidades_validate_pecas

  function do_ajax_form_tblnaoconformidades_validate_pecas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pecas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnaoconformidades_validate_pecas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblnaoconformidades_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblnaoconformidades_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblnaoconformidades_submit_form(var_intnaoconformidadeid, var_dtaidentificacao, var_strnaoconformidade, var_strdescricao, var_strnorma, var_intstatusncid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblnaoconformidades_submit_form_cb);
  } // do_ajax_form_tblnaoconformidades_submit_form

  function do_ajax_form_tblnaoconformidades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblnaoconformidades_submit_form_cb_after_alert);
  } // do_ajax_form_tblnaoconformidades_submit_form_cb
  function do_ajax_form_tblnaoconformidades_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblnaoconformidades_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_tblncveiculos"] = "off";
  scStatusDetail["form_tblncpecas"] = "off";

  function do_ajax_form_tblnaoconformidades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tblncveiculos"] = "on";
    scStatusDetail["form_tblncpecas"] = "on";
    x_ajax_form_tblnaoconformidades_navigate_form(var_intnaoconformidadeid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblnaoconformidades_navigate_form_cb);
  } // do_ajax_form_tblnaoconformidades_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblnaoconformidades']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblnaoconformidades_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblnaoconformidades_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblncveiculos"] && "nmsc_iframe_liga_form_tblncveiculos" != scMasterDetailIframe["nmsc_iframe_liga_form_tblncveiculos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblncveiculos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblncveiculos').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tblncveiculos').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tblncveiculos').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tblncpecas"] && "nmsc_iframe_liga_form_tblncpecas" != scMasterDetailIframe["nmsc_iframe_liga_form_tblncpecas"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tblncpecas"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tblncpecas').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_tblncpecas').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_tblncpecas').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblnaoconformidades_navigate_form_cb_after_alert);
  } // do_ajax_form_tblnaoconformidades_navigate_form_cb
  function do_ajax_form_tblnaoconformidades_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblnaoconformidades_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblnaoconformidades_navigate_form_cb_after_alert
  function sc_hide_form_tblnaoconformidades_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tblncveiculos"] && "off" == scStatusDetail["form_tblncpecas"])
    {
      return true;
    }
    return false;
