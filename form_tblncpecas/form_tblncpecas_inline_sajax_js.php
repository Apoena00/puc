  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblncpecas_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblncpecas_inline_validate_intnaoconformidadeid_()
  {
    ...
    x_ajax_form_tblncpecas_inline_validate_intnaoconformidadeid_(var_intnaoconformidadeid_, var_script_case_init, do_ajax_form_tblncpecas_inline_validate_intnaoconformidadeid__cb);
  } // do_ajax_form_tblncpecas_inline_validate_intnaoconformidadeid_

  function do_ajax_form_tblncpecas_inline_validate_intnaoconformidadeid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_inline_validate_intnaoconformidadeid__cb

  // ---------- Validate intpecaid_
  function do_ajax_form_tblncpecas_inline_validate_intpecaid_()
  {
    var nomeCampo_intpecaid_ = "intpecaid_";
    var var_intpecaid_ = scAjaxGetFieldSelect(nomeCampo_intpecaid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_inline_validate_intpecaid_(var_intpecaid_, var_script_case_init, do_ajax_form_tblncpecas_inline_validate_intpecaid__cb);
  } // do_ajax_form_tblncpecas_inline_validate_intpecaid_

  function do_ajax_form_tblncpecas_inline_validate_intpecaid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_inline_validate_intpecaid__cb

  // ---------- Validate strobservacao_
  function do_ajax_form_tblncpecas_inline_validate_strobservacao_()
  {
    var nomeCampo_strobservacao_ = "strobservacao_";
    var var_strobservacao_ = scAjaxGetFieldText(nomeCampo_strobservacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_inline_validate_strobservacao_(var_strobservacao_, var_script_case_init, do_ajax_form_tblncpecas_inline_validate_strobservacao__cb);
  } // do_ajax_form_tblncpecas_inline_validate_strobservacao_

  function do_ajax_form_tblncpecas_inline_validate_strobservacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_inline_validate_strobservacao__cb

  // ---------- Validate intstatusncid_
  function do_ajax_form_tblncpecas_inline_validate_intstatusncid_()
  {
    var nomeCampo_intstatusncid_ = "intstatusncid_";
    var var_intstatusncid_ = scAjaxGetFieldSelect(nomeCampo_intstatusncid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_inline_validate_intstatusncid_(var_intstatusncid_, var_script_case_init, do_ajax_form_tblncpecas_inline_validate_intstatusncid__cb);
  } // do_ajax_form_tblncpecas_inline_validate_intstatusncid_

  function do_ajax_form_tblncpecas_inline_validate_intstatusncid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_inline_validate_intstatusncid__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblncpecas_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblncpecas_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intnaoconformidadeid_ = scAjaxGetFieldText("intnaoconformidadeid_");
    var var_intpecaid_ = scAjaxGetFieldSelect("intpecaid_");
    ...
    scAjaxProcOn();
    x_ajax_form_tblncpecas_inline_submit_form(var_intnaoconformidadeid_, var_intpecaid_, var_strobservacao_, var_intstatusncid_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblncpecas_inline_submit_form_cb);
  } // do_ajax_form_tblncpecas_inline_submit_form

  function do_ajax_form_tblncpecas_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("intpecaid_");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblncpecas_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tblncpecas_inline_submit_form_cb
  function do_ajax_form_tblncpecas_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblncpecas_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblncpecas_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblncpecas_inline_navigate_form(var_intnaoconformidadeid_, var_intpecaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblncpecas_inline_navigate_form_cb);
  } // do_ajax_form_tblncpecas_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblncpecas_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblncpecas_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblncpecas_inline_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblncpecas_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tblncpecas_inline_navigate_form_cb
  function do_ajax_form_tblncpecas_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tblncpecas_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblncpecas_inline_navigate_form_cb_after_alert
  function sc_hide_form_tblncpecas_inline_form()
  {
  ...
  var ajax_error_list = {
    "intnaoconformidadeid_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_intnaoconformidadeid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intpecaid_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_intpecaid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strobservacao_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_strobservacao'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intstatusncid_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_intstatusncid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["intpecaid_"][1] = "intpecaid_";
  ajax_field_mult["strobservacao_"][1] = "strobservacao_";
  ajax_field_mult["intstatusncid_"][1] = "intstatusncid_";

  var ajax_field_id = {
    "intpecaid_": new Array("hidden_field_label_intpecaid_", "hidden_field_data_intpecaid_"),
