  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblncpecas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblncpecas_validate_intnaoconformidadeid_(iNumLinha)
  {
    ...
    x_ajax_form_tblncpecas_validate_intnaoconformidadeid_(var_intnaoconformidadeid_, iNumLinha, var_script_case_init, do_ajax_form_tblncpecas_validate_intnaoconformidadeid__cb);
  } // do_ajax_form_tblncpecas_validate_intnaoconformidadeid_

  function do_ajax_form_tblncpecas_validate_intnaoconformidadeid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_validate_intnaoconformidadeid__cb

  // ---------- Validate intpecaid_
  function do_ajax_form_tblncpecas_validate_intpecaid_(iNumLinha)
  {
    var nomeCampo_intpecaid_ = "intpecaid_" + iNumLinha;
    var var_intpecaid_ = scAjaxGetFieldSelect(nomeCampo_intpecaid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_validate_intpecaid_(var_intpecaid_, iNumLinha, var_script_case_init, do_ajax_form_tblncpecas_validate_intpecaid__cb);
  } // do_ajax_form_tblncpecas_validate_intpecaid_

  function do_ajax_form_tblncpecas_validate_intpecaid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "intpecaid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "intpecaid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "intpecaid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "intpecaid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_validate_intpecaid__cb

  // ---------- Validate strobservacao_
  function do_ajax_form_tblncpecas_validate_strobservacao_(iNumLinha)
  {
    var nomeCampo_strobservacao_ = "strobservacao_" + iNumLinha;
    var var_strobservacao_ = scAjaxGetFieldText(nomeCampo_strobservacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_validate_strobservacao_(var_strobservacao_, iNumLinha, var_script_case_init, do_ajax_form_tblncpecas_validate_strobservacao__cb);
  } // do_ajax_form_tblncpecas_validate_strobservacao_

  function do_ajax_form_tblncpecas_validate_strobservacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_validate_strobservacao__cb

  // ---------- Validate intstatusncid_
  function do_ajax_form_tblncpecas_validate_intstatusncid_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_validate_intstatusncid_(var_intstatusncid_, iNumLinha, var_script_case_init, do_ajax_form_tblncpecas_validate_intstatusncid__cb);
  } // do_ajax_form_tblncpecas_validate_intstatusncid_

  function do_ajax_form_tblncpecas_validate_intstatusncid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncpecas_validate_intstatusncid__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tblncpecas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tblncpecas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblncpecas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tblncpecas_add_new_line_cb);
  } // do_ajax_form_tblncpecas_add_new_line

  function do_ajax_form_tblncpecas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tblncpecas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tblncpecas_backup_line(iNumLinha)
  {
    var var_intnaoconformidadeid_ = scAjaxGetFieldText("intnaoconformidadeid_" + iNumLinha);
    var var_intpecaid_ = scAjaxGetFieldSelect("intpecaid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncpecas_backup_line(var_intnaoconformidadeid_, var_intpecaid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tblncpecas_backup_line_cb);
  } // do_ajax_form_tblncpecas_backup_line

  function do_ajax_form_tblncpecas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tblncpecas_backup_line_cb

  function do_ajax_form_tblncpecas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tblncpecas_cancel_insert

  function do_ajax_form_tblncpecas_cancel_update(iSeqVert)
  {
    do_ajax_form_tblncpecas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tblncpecas_cancel_update

  function do_ajax_form_tblncpecas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tblncpecas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tblncpecas_table_refresh()
  {
    var var_intnaoconformidadeid_ = document.F2.intnaoconformidadeid_.value;
    var var_intpecaid_ = document.F2.intpecaid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblncpecas_table_refresh(var_intnaoconformidadeid_, var_intpecaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblncpecas_table_refresh_cb);
  } //  do_ajax_form_tblncpecas_table_refresh

  function do_ajax_form_tblncpecas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.intpecaid_.value = scAjaxGetKeyValue("intpecaid_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_tblncpecas_table_refresh_cb_after_alert);
  } // do_ajax_form_tblncpecas_table_refresh_cb
  function do_ajax_form_tblncpecas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tblncpecas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tblncpecas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tblncpecas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tblncpecas_submit_form(var_intnaoconformidadeid_, var_intpecaid_, var_strobservacao_, var_intstatusncid_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblncpecas_submit_form_cb);
  } // do_ajax_form_tblncpecas_submit_form

  function do_ajax_form_tblncpecas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("intpecaid_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tblncpecas_submit_form_cb_after_alert);
  } // do_ajax_form_tblncpecas_submit_form_cb
  function do_ajax_form_tblncpecas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblncpecas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblncpecas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tblncpecas_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("intpecaid_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblncpecas_navigate_form(var_intnaoconformidadeid_, var_intpecaid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblncpecas_navigate_form_cb);
  } // do_ajax_form_tblncpecas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblncpecas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblncpecas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.intpecaid_.value = scAjaxGetKeyValue("intpecaid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblncpecas_navigate_form_cb_after_alert);
  } // do_ajax_form_tblncpecas_navigate_form_cb
  function do_ajax_form_tblncpecas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tblncpecas_navigate_form_cb_after_alert
  function sc_hide_form_tblncpecas_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tblncpecas_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "intpecaid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "strobservacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "intstatusncid_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["intnaoconformidadeid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_intnaoconformidadeid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["intpecaid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_intpecaid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["strobservacao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_strobservacao'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["intstatusncid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncpecas_fld_intstatusncid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["intnaoconformidadeid_"][iNumLinha] = "intnaoconformidadeid_" + iNumLinha;
    ajax_field_mult["intpecaid_"][iNumLinha] = "intpecaid_" + iNumLinha;
    ...
    ajax_field_id["intpecaid_" + iNumLinha] = new Array("hidden_field_label_intpecaid_", "hidden_field_data_intpecaid_" + iNumLinha);
    ...
    ajax_error_count["intpecaid_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["intpecaid_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["intpecaid_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["intpecaid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["intpecaid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["intpecaid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["intpecaid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["intpecaid_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['intpecaid_'])) ? $this->nmgp_cmp_readonly['intpecaid_'] : 'on';
?>
    scAjaxFieldRead("intpecaid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("intpecaid_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["intnaoconformidadeid_" + iRow] || "on" == ajax_error_count["intpecaid_" + iRow] || "on" == ajax_error_count["strobservacao_" + iRow] || "on" == ajax_error_count["intstatusncid_" + iRow]))
    {
      ...
      $("#hidden_field_data_intpecaid_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["intnaoconformidadeid_" + iRow] && "off" == ajax_error_count["intpecaid_" + iRow] && "off" == ajax_error_count["strobservacao_" + iRow] && "off" == ajax_error_count["intstatusncid_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["intnaoconformidadeid_" + iRow] = "off";
        ajax_error_count["intpecaid_" + iRow] = "off";
      ...
      $("#hidden_field_data_intpecaid_" + iRow).removeClass("scFormErrorLine");
