  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblncveiculos_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblncveiculos_inline_validate_intnaoconformidadeid_()
  {
    var nomeCampo_intnaoconformidadeid_ = "intnaoconformidadeid_";
    var var_intnaoconformidadeid_ = scAjaxGetFieldText(nomeCampo_intnaoconformidadeid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_inline_validate_intnaoconformidadeid_(var_intnaoconformidadeid_, var_script_case_init, do_ajax_form_tblncveiculos_inline_validate_intnaoconformidadeid__cb);
  } // do_ajax_form_tblncveiculos_inline_validate_intnaoconformidadeid_

  function do_ajax_form_tblncveiculos_inline_validate_intnaoconformidadeid__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_inline_validate_intnaoconformidadeid__cb

  // ---------- Validate intveiculoid_
  function do_ajax_form_tblncveiculos_inline_validate_intveiculoid_()
  {
    var nomeCampo_intveiculoid_ = "intveiculoid_";
    var var_intveiculoid_ = scAjaxGetFieldSelect(nomeCampo_intveiculoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_inline_validate_intveiculoid_(var_intveiculoid_, var_script_case_init, do_ajax_form_tblncveiculos_inline_validate_intveiculoid__cb);
  } // do_ajax_form_tblncveiculos_inline_validate_intveiculoid_

  function do_ajax_form_tblncveiculos_inline_validate_intveiculoid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_inline_validate_intveiculoid__cb

  // ---------- Validate strobservacao_
  function do_ajax_form_tblncveiculos_inline_validate_strobservacao_()
  {
    var nomeCampo_strobservacao_ = "strobservacao_";
    var var_strobservacao_ = scAjaxGetFieldText(nomeCampo_strobservacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_inline_validate_strobservacao_(var_strobservacao_, var_script_case_init, do_ajax_form_tblncveiculos_inline_validate_strobservacao__cb);
  } // do_ajax_form_tblncveiculos_inline_validate_strobservacao_

  function do_ajax_form_tblncveiculos_inline_validate_strobservacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_inline_validate_strobservacao__cb

  // ---------- Validate intstatusncid_
  function do_ajax_form_tblncveiculos_inline_validate_intstatusncid_()
  {
    var nomeCampo_intstatusncid_ = "intstatusncid_";
    var var_intstatusncid_ = scAjaxGetFieldSelect(nomeCampo_intstatusncid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_inline_validate_intstatusncid_(var_intstatusncid_, var_script_case_init, do_ajax_form_tblncveiculos_inline_validate_intstatusncid__cb);
  } // do_ajax_form_tblncveiculos_inline_validate_intstatusncid_

  function do_ajax_form_tblncveiculos_inline_validate_intstatusncid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_inline_validate_intstatusncid__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblncveiculos_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblncveiculos_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intnaoconformidadeid_ = scAjaxGetFieldText("intnaoconformidadeid_");
    var var_intveiculoid_ = scAjaxGetFieldSelect("intveiculoid_");
    var var_strobservacao_ = scAjaxGetFieldText("strobservacao_");
    var var_intstatusncid_ = scAjaxGetFieldSelect("intstatusncid_");
    ...
    scAjaxProcOn();
    x_ajax_form_tblncveiculos_inline_submit_form(var_intnaoconformidadeid_, var_intveiculoid_, var_strobservacao_, var_intstatusncid_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblncveiculos_inline_submit_form_cb);
  } // do_ajax_form_tblncveiculos_inline_submit_form

  function do_ajax_form_tblncveiculos_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("intnaoconformidadeid_");
      scAjaxHideErrorDisplay("intveiculoid_");
      scAjaxHideErrorDisplay("strobservacao_");
      scAjaxHideErrorDisplay("intstatusncid_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblncveiculos_inline_submit_form_cb_after_alert);
  } // do_ajax_form_tblncveiculos_inline_submit_form_cb
  function do_ajax_form_tblncveiculos_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblncveiculos_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblncveiculos_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblncveiculos_inline_navigate_form(var_intnaoconformidadeid_, var_intveiculoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblncveiculos_inline_navigate_form_cb);
  } // do_ajax_form_tblncveiculos_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblncveiculos_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblncveiculos_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblncveiculos_inline_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblncveiculos_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_tblncveiculos_inline_navigate_form_cb
  function do_ajax_form_tblncveiculos_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tblncveiculos_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblncveiculos_inline_navigate_form_cb_after_alert
  function sc_hide_form_tblncveiculos_inline_form()
  {
  ...
  ajax_field_list[0] = "intnaoconformidadeid_";
  ajax_field_list[1] = "intveiculoid_";
  ajax_field_list[2] = "strobservacao_";
  ajax_field_list[3] = "intstatusncid_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "intnaoconformidadeid_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_intnaoconformidadeid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intveiculoid_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_intveiculoid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strobservacao_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_strobservacao'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "intstatusncid_": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_intstatusncid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["intnaoconformidadeid_"][1] = "intnaoconformidadeid_";
  ajax_field_mult["intveiculoid_"][1] = "intveiculoid_";
  ajax_field_mult["strobservacao_"][1] = "strobservacao_";
  ajax_field_mult["intstatusncid_"][1] = "intstatusncid_";

  var ajax_field_id = {
    "intveiculoid_": new Array("hidden_field_label_intveiculoid_", "hidden_field_data_intveiculoid_"),
    "strobservacao_": new Array("hidden_field_label_strobservacao_", "hidden_field_data_strobservacao_"),
    "intstatusncid_": new Array("hidden_field_label_intstatusncid_", "hidden_field_data_intstatusncid_")
  };

  var ajax_read_only = {
    "intnaoconformidadeid_": "on",
    "intveiculoid_": "on",
    "strobservacao_": "off",
    "intstatusncid_": "off"
  };
