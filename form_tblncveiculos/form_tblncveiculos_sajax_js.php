  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblncveiculos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate intnaoconformidadeid_
  function do_ajax_form_tblncveiculos_validate_intnaoconformidadeid_(iNumLinha)
  {
    var nomeCampo_intnaoconformidadeid_ = "intnaoconformidadeid_" + iNumLinha;
    var var_intnaoconformidadeid_ = scAjaxGetFieldText(nomeCampo_intnaoconformidadeid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_validate_intnaoconformidadeid_(var_intnaoconformidadeid_, iNumLinha, var_script_case_init, do_ajax_form_tblncveiculos_validate_intnaoconformidadeid__cb);
  } // do_ajax_form_tblncveiculos_validate_intnaoconformidadeid_

  function do_ajax_form_tblncveiculos_validate_intnaoconformidadeid__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "intnaoconformidadeid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "intnaoconformidadeid_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "intnaoconformidadeid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "intnaoconformidadeid_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_validate_intnaoconformidadeid__cb

  // ---------- Validate intveiculoid_
  function do_ajax_form_tblncveiculos_validate_intveiculoid_(iNumLinha)
  {
    var nomeCampo_intveiculoid_ = "intveiculoid_" + iNumLinha;
    var var_intveiculoid_ = scAjaxGetFieldSelect(nomeCampo_intveiculoid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_validate_intveiculoid_(var_intveiculoid_, iNumLinha, var_script_case_init, do_ajax_form_tblncveiculos_validate_intveiculoid__cb);
  } // do_ajax_form_tblncveiculos_validate_intveiculoid_

  function do_ajax_form_tblncveiculos_validate_intveiculoid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "intveiculoid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "intveiculoid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "intveiculoid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "intveiculoid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_validate_intveiculoid__cb

  // ---------- Validate strobservacao_
  function do_ajax_form_tblncveiculos_validate_strobservacao_(iNumLinha)
  {
    var nomeCampo_strobservacao_ = "strobservacao_" + iNumLinha;
    var var_strobservacao_ = scAjaxGetFieldText(nomeCampo_strobservacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_validate_strobservacao_(var_strobservacao_, iNumLinha, var_script_case_init, do_ajax_form_tblncveiculos_validate_strobservacao__cb);
  } // do_ajax_form_tblncveiculos_validate_strobservacao_

  function do_ajax_form_tblncveiculos_validate_strobservacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "strobservacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "strobservacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "strobservacao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "strobservacao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_validate_strobservacao__cb

  // ---------- Validate intstatusncid_
  function do_ajax_form_tblncveiculos_validate_intstatusncid_(iNumLinha)
  {
    var nomeCampo_intstatusncid_ = "intstatusncid_" + iNumLinha;
    var var_intstatusncid_ = scAjaxGetFieldSelect(nomeCampo_intstatusncid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_validate_intstatusncid_(var_intstatusncid_, iNumLinha, var_script_case_init, do_ajax_form_tblncveiculos_validate_intstatusncid__cb);
  } // do_ajax_form_tblncveiculos_validate_intstatusncid_

  function do_ajax_form_tblncveiculos_validate_intstatusncid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "intstatusncid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "intstatusncid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "intstatusncid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "intstatusncid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblncveiculos_validate_intstatusncid__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tblncveiculos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tblncveiculos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tblncveiculos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tblncveiculos_add_new_line_cb);
  } // do_ajax_form_tblncveiculos_add_new_line

  function do_ajax_form_tblncveiculos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tblncveiculos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tblncveiculos_backup_line(iNumLinha)
  {
    var var_intnaoconformidadeid_ = scAjaxGetFieldText("intnaoconformidadeid_" + iNumLinha);
    var var_intveiculoid_ = scAjaxGetFieldSelect("intveiculoid_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblncveiculos_backup_line(var_intnaoconformidadeid_, var_intveiculoid_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tblncveiculos_backup_line_cb);
  } // do_ajax_form_tblncveiculos_backup_line

  function do_ajax_form_tblncveiculos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tblncveiculos_backup_line_cb

  function do_ajax_form_tblncveiculos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tblncveiculos_cancel_insert

  function do_ajax_form_tblncveiculos_cancel_update(iSeqVert)
  {
    do_ajax_form_tblncveiculos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tblncveiculos_cancel_update

  function do_ajax_form_tblncveiculos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tblncveiculos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tblncveiculos_table_refresh()
  {
    var var_intnaoconformidadeid_ = document.F2.intnaoconformidadeid_.value;
    var var_intveiculoid_ = document.F2.intveiculoid_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblncveiculos_table_refresh(var_intnaoconformidadeid_, var_intveiculoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblncveiculos_table_refresh_cb);
  } //  do_ajax_form_tblncveiculos_table_refresh

  function do_ajax_form_tblncveiculos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.intnaoconformidadeid_.value = scAjaxGetKeyValue("intnaoconformidadeid_");
    document.F2.intveiculoid_.value = scAjaxGetKeyValue("intveiculoid_");
    ...
    scQSInit = false;
    scAjaxAlert(do_ajax_form_tblncveiculos_table_refresh_cb_after_alert);
  } // do_ajax_form_tblncveiculos_table_refresh_cb
  function do_ajax_form_tblncveiculos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tblncveiculos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tblncveiculos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tblncveiculos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_intnaoconformidadeid_ = scAjaxGetFieldText("intnaoconformidadeid_" + iNumLinha);
    var var_intveiculoid_ = scAjaxGetFieldSelect("intveiculoid_" + iNumLinha);
    var var_strobservacao_ = scAjaxGetFieldText("strobservacao_" + iNumLinha);
    var var_intstatusncid_ = scAjaxGetFieldSelect("intstatusncid_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tblncveiculos_submit_form(var_intnaoconformidadeid_, var_intveiculoid_, var_strobservacao_, var_intstatusncid_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblncveiculos_submit_form_cb);
  } // do_ajax_form_tblncveiculos_submit_form

  function do_ajax_form_tblncveiculos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("intnaoconformidadeid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("intveiculoid_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("strobservacao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("intstatusncid_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tblncveiculos_submit_form_cb_after_alert);
  } // do_ajax_form_tblncveiculos_submit_form_cb
  function do_ajax_form_tblncveiculos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblncveiculos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblncveiculos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tblncveiculos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("intnaoconformidadeid_" + iNavForm);
      scAjaxHideErrorDisplay("intveiculoid_" + iNavForm);
      scAjaxHideErrorDisplay("strobservacao_" + iNavForm);
      scAjaxHideErrorDisplay("intstatusncid_" + iNavForm);
    }
    var var_intnaoconformidadeid_ = document.F2.intnaoconformidadeid_.value;
    var var_intveiculoid_ = document.F2.intveiculoid_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tblncveiculos_navigate_form(var_intnaoconformidadeid_, var_intveiculoid_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblncveiculos_navigate_form_cb);
  } // do_ajax_form_tblncveiculos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblncveiculos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblncveiculos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.intnaoconformidadeid_.value = scAjaxGetKeyValue("intnaoconformidadeid_" + var_last_index);
    document.F2.intveiculoid_.value = scAjaxGetKeyValue("intveiculoid_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblncveiculos_navigate_form_cb_after_alert);
  } // do_ajax_form_tblncveiculos_navigate_form_cb
  function do_ajax_form_tblncveiculos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tblncveiculos_navigate_form_cb_after_alert
  function sc_hide_form_tblncveiculos_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tblncveiculos_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "intnaoconformidadeid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "intveiculoid_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "strobservacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "intstatusncid_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["intnaoconformidadeid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_intnaoconformidadeid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["intveiculoid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_intveiculoid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["strobservacao_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_strobservacao'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["intstatusncid_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_tblncveiculos_fld_intstatusncid'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["intnaoconformidadeid_"][iNumLinha] = "intnaoconformidadeid_" + iNumLinha;
    ajax_field_mult["intveiculoid_"][iNumLinha] = "intveiculoid_" + iNumLinha;
    ajax_field_mult["strobservacao_"][iNumLinha] = "strobservacao_" + iNumLinha;
    ajax_field_mult["intstatusncid_"][iNumLinha] = "intstatusncid_" + iNumLinha;
    ajax_field_id["intveiculoid_" + iNumLinha] = new Array("hidden_field_label_intveiculoid_", "hidden_field_data_intveiculoid_" + iNumLinha);
    ajax_field_id["strobservacao_" + iNumLinha] = new Array("hidden_field_label_strobservacao_", "hidden_field_data_strobservacao_" + iNumLinha);
    ajax_field_id["intstatusncid_" + iNumLinha] = new Array("hidden_field_label_intstatusncid_", "hidden_field_data_intstatusncid_" + iNumLinha);
    ajax_error_count["intnaoconformidadeid_" + iNumLinha] = "off";
    ajax_error_count["intveiculoid_" + iNumLinha] = "off";
    ajax_error_count["strobservacao_" + iNumLinha] = "off";
    ajax_error_count["intstatusncid_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["intnaoconformidadeid_" + iNumLinha] = "on";
    ajax_read_only["intveiculoid_" + iNumLinha] = "on";
    ajax_read_only["strobservacao_" + iNumLinha] = "off";
    ajax_read_only["intstatusncid_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["intnaoconformidadeid_" + iNumLinha] = "on";
    ajax_read_only["intveiculoid_" + iNumLinha] = "on";
    ajax_read_only["strobservacao_" + iNumLinha] = "on";
    ajax_read_only["intstatusncid_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["intnaoconformidadeid_" + iNumLinha] = null;
    ajax_error_list["intveiculoid_" + iNumLinha] = null;
    ajax_error_list["strobservacao_" + iNumLinha] = null;
    ajax_error_list["intstatusncid_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "intnaoconformidadeid_": new Array(),
    "intveiculoid_": new Array(),
    "strobservacao_": new Array(),
    "intstatusncid_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["intnaoconformidadeid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["intnaoconformidadeid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["intnaoconformidadeid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["intnaoconformidadeid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["intnaoconformidadeid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["intveiculoid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["intveiculoid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["intveiculoid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["intveiculoid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["intveiculoid_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["strobservacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["strobservacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["strobservacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["strobservacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["strobservacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["intstatusncid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["intstatusncid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["intstatusncid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["intstatusncid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["intstatusncid_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['intnaoconformidadeid_'])) ? $this->nmgp_cmp_readonly['intnaoconformidadeid_'] : 'on';
?>
    scAjaxFieldRead("intnaoconformidadeid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['intveiculoid_'])) ? $this->nmgp_cmp_readonly['intveiculoid_'] : 'on';
?>
    scAjaxFieldRead("intveiculoid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['strobservacao_'])) ? $this->nmgp_cmp_readonly['strobservacao_'] : 'off';
?>
    scAjaxFieldRead("strobservacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['intstatusncid_'])) ? $this->nmgp_cmp_readonly['intstatusncid_'] : 'off';
?>
    scAjaxFieldRead("intstatusncid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("intnaoconformidadeid_" + iSeq, "on");
    scAjaxFieldRead("intveiculoid_" + iSeq, "on");
    scAjaxFieldRead("strobservacao_" + iSeq, "on");
    scAjaxFieldRead("intstatusncid_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["intnaoconformidadeid_" + iRow] || "on" == ajax_error_count["intveiculoid_" + iRow] || "on" == ajax_error_count["strobservacao_" + iRow] || "on" == ajax_error_count["intstatusncid_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_intnaoconformidadeid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_intveiculoid_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_strobservacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_intstatusncid_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["intnaoconformidadeid_" + iRow] && "off" == ajax_error_count["intveiculoid_" + iRow] && "off" == ajax_error_count["strobservacao_" + iRow] && "off" == ajax_error_count["intstatusncid_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["intnaoconformidadeid_" + iRow] = "off";
        ajax_error_count["intveiculoid_" + iRow] = "off";
        ajax_error_count["strobservacao_" + iRow] = "off";
        ajax_error_count["intstatusncid_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_intnaoconformidadeid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_intveiculoid_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_strobservacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_intstatusncid_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("intnaoconformidadeid_" == sIndex)
    {
