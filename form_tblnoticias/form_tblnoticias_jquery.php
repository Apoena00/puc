...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dtanoticia_hora' + iSeqRow).bind('blur', function() { sc_form_tblnoticias_dtanoticia_hora_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tblnoticias_dtanoticia_hora_onfocus(this, iSeqRow) });
...
function sc_form_tblnoticias_dtanoticia_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_tblnoticias_validate_dtanoticia();
  scCssBlur(oThis);
}
...
function sc_form_tblnoticias_dtanoticia_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_tblnoticias_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dtanoticia" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tblnoticias_validate_dtanoticia(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imgnoticia" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_tblnoticias_ul_save.php",
