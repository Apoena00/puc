  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblnoticias_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate intnoticiaid
  function do_ajax_form_tblnoticias_mob_validate_intnoticiaid()
  {
    var nomeCampo_intnoticiaid = "intnoticiaid";
    var var_intnoticiaid = scAjaxGetFieldHidden(nomeCampo_intnoticiaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_mob_validate_intnoticiaid(var_intnoticiaid, var_script_case_init, do_ajax_form_tblnoticias_mob_validate_intnoticiaid_cb);
  } // do_ajax_form_tblnoticias_mob_validate_intnoticiaid

  function do_ajax_form_tblnoticias_mob_validate_intnoticiaid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intnoticiaid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_mob_validate_intnoticiaid_cb

  // ---------- Validate dtanoticia
  function do_ajax_form_tblnoticias_mob_validate_dtanoticia()
  {
    var nomeCampo_dtanoticia = "dtanoticia";
    var var_dtanoticia = scAjaxGetFieldText(nomeCampo_dtanoticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_mob_validate_dtanoticia(var_dtanoticia, var_script_case_init, do_ajax_form_tblnoticias_mob_validate_dtanoticia_cb);
  } // do_ajax_form_tblnoticias_mob_validate_dtanoticia

  function do_ajax_form_tblnoticias_mob_validate_dtanoticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtanoticia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_mob_validate_dtanoticia_cb

  // ---------- Validate strtitulo
  function do_ajax_form_tblnoticias_mob_validate_strtitulo()
  {
    var nomeCampo_strtitulo = "strtitulo";
    var var_strtitulo = scAjaxGetFieldText(nomeCampo_strtitulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_mob_validate_strtitulo(var_strtitulo, var_script_case_init, do_ajax_form_tblnoticias_mob_validate_strtitulo_cb);
  } // do_ajax_form_tblnoticias_mob_validate_strtitulo

  function do_ajax_form_tblnoticias_mob_validate_strtitulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strtitulo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_mob_validate_strtitulo_cb

  // ---------- Validate strnoticia
  function do_ajax_form_tblnoticias_mob_validate_strnoticia()
  {
    var nomeCampo_strnoticia = "strnoticia";
    var var_strnoticia = scAjaxGetFieldEditorHtml(nomeCampo_strnoticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_mob_validate_strnoticia(var_strnoticia, var_script_case_init, do_ajax_form_tblnoticias_mob_validate_strnoticia_cb);
  } // do_ajax_form_tblnoticias_mob_validate_strnoticia

  function do_ajax_form_tblnoticias_mob_validate_strnoticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strnoticia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_mob_validate_strnoticia_cb

  // ---------- Validate imgnoticia
  function do_ajax_form_tblnoticias_mob_validate_imgnoticia()
  {
    var nomeCampo_imgnoticia = "imgnoticia";
    var var_imgnoticia = scAjaxGetFieldText(nomeCampo_imgnoticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_mob_validate_imgnoticia(var_imgnoticia, var_script_case_init, do_ajax_form_tblnoticias_mob_validate_imgnoticia_cb);
  } // do_ajax_form_tblnoticias_mob_validate_imgnoticia

  function do_ajax_form_tblnoticias_mob_validate_imgnoticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imgnoticia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_mob_validate_imgnoticia_cb

  // ---------- Validate bolfeed
  function do_ajax_form_tblnoticias_mob_validate_bolfeed()
  {
    var nomeCampo_bolfeed = "bolfeed";
    var var_bolfeed = scAjaxGetFieldCheckbox(nomeCampo_bolfeed, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_mob_validate_bolfeed(var_bolfeed, var_script_case_init, do_ajax_form_tblnoticias_mob_validate_bolfeed_cb);
  } // do_ajax_form_tblnoticias_mob_validate_bolfeed

  function do_ajax_form_tblnoticias_mob_validate_bolfeed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bolfeed";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_mob_validate_bolfeed_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblnoticias_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblnoticias_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intnoticiaid = scAjaxGetFieldHidden("intnoticiaid");
    var var_dtanoticia = scAjaxGetFieldText("dtanoticia");
    var var_strtitulo = scAjaxGetFieldText("strtitulo");
    var var_strnoticia = scAjaxGetFieldEditorHtml("strnoticia");
    var var_imgnoticia = scAjaxGetFieldText("imgnoticia");
    var var_bolfeed = scAjaxGetFieldCheckbox("bolfeed", ";");
    var var_imgnoticia_ul_name = scAjaxSpecCharProtect(document.F1.imgnoticia_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imgnoticia_ul_type = document.F1.imgnoticia_ul_type.value;
    var var_imgnoticia_salva = scAjaxSpecCharProtect(document.F1.imgnoticia_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imgnoticia_limpa = document.F1.imgnoticia_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_tblnoticias_mob_submit_form(var_intnoticiaid, var_dtanoticia, var_strtitulo, var_strnoticia, var_imgnoticia, var_bolfeed, var_imgnoticia_ul_name, var_imgnoticia_ul_type, var_imgnoticia_salva, var_imgnoticia_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblnoticias_mob_submit_form_cb);
  } // do_ajax_form_tblnoticias_mob_submit_form

  function do_ajax_form_tblnoticias_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("intnoticiaid");
      scAjaxHideErrorDisplay("dtanoticia");
      scAjaxHideErrorDisplay("strtitulo");
      scAjaxHideErrorDisplay("strnoticia");
      scAjaxHideErrorDisplay("imgnoticia");
      scAjaxHideErrorDisplay("bolfeed");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.imgnoticia_limpa && document.F1.imgnoticia_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("imgnoticia", oImgTemp, "", "", "", "N");
      }
    document.F1.imgnoticia_ul_name.value = '';
    document.F1.imgnoticia_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblnoticias_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblnoticias_mob_submit_form_cb
  function do_ajax_form_tblnoticias_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblnoticias_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblnoticias_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("imgnoticia");
    scAjaxHideErrorDisplay("bolfeed");
    var var_intnoticiaid = document.F2.intnoticiaid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblnoticias_mob_navigate_form(var_intnoticiaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblnoticias_mob_navigate_form_cb);
  } // do_ajax_form_tblnoticias_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblnoticias_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblnoticias_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblnoticias_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.intnoticiaid.value = scAjaxGetKeyValue("intnoticiaid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblnoticias_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblnoticias_mob_navigate_form_cb
  function do_ajax_form_tblnoticias_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblnoticias_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblnoticias_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblnoticias_mob_form()
  {
  ...
  ajax_field_list[0] = "intnoticiaid";
  ajax_field_list[1] = "dtanoticia";
  ajax_field_list[2] = "strtitulo";
  ajax_field_list[3] = "strnoticia";
  ajax_field_list[4] = "imgnoticia";
  ajax_field_list[5] = "bolfeed";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "intnoticiaid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnoticias_fld_intnoticiaid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtanoticia": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnoticias_fld_dtanoticia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strtitulo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnoticias_fld_strtitulo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strnoticia": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnoticias_fld_strnoticia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imgnoticia": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnoticias_fld_imgnoticia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bolfeed": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblnoticias_fld_bolfeed'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "intnoticiaid": new Array(),
    "dtanoticia": new Array(),
    "strtitulo": new Array(),
    "strnoticia": new Array(),
    "imgnoticia": new Array(),
    "bolfeed": new Array()
  };
  ajax_field_mult["intnoticiaid"][1] = "intnoticiaid";
  ajax_field_mult["dtanoticia"][1] = "dtanoticia";
  ajax_field_mult["strtitulo"][1] = "strtitulo";
  ajax_field_mult["strnoticia"][1] = "strnoticia";
  ajax_field_mult["imgnoticia"][1] = "imgnoticia";
  ajax_field_mult["bolfeed"][1] = "bolfeed";

  var ajax_field_id = {
    "intnoticiaid": new Array("hidden_field_label_intnoticiaid", "hidden_field_data_intnoticiaid"),
    "dtanoticia": new Array("hidden_field_label_dtanoticia", "hidden_field_data_dtanoticia"),
    "strtitulo": new Array("hidden_field_label_strtitulo", "hidden_field_data_strtitulo"),
    "strnoticia": new Array("hidden_field_label_strnoticia", "hidden_field_data_strnoticia"),
    "imgnoticia": new Array("hidden_field_label_imgnoticia", "hidden_field_data_imgnoticia"),
    "bolfeed": new Array("hidden_field_label_bolfeed", "hidden_field_data_bolfeed")
  };
