  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblnoticias" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblnoticias_validate_intnoticiaid()
  {
    var nomeCampo_intnoticiaid = "intnoticiaid";
    var var_intnoticiaid = scAjaxGetFieldHidden(nomeCampo_intnoticiaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_validate_intnoticiaid(var_intnoticiaid, var_script_case_init, do_ajax_form_tblnoticias_validate_intnoticiaid_cb);
  } // do_ajax_form_tblnoticias_validate_intnoticiaid

  function do_ajax_form_tblnoticias_validate_intnoticiaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_validate_intnoticiaid_cb

  // ---------- Validate dtanoticia
  function do_ajax_form_tblnoticias_validate_dtanoticia()
  {
    var nomeCampo_dtanoticia = "dtanoticia";
    var var_dtanoticia = scAjaxGetFieldText(nomeCampo_dtanoticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_validate_dtanoticia(var_dtanoticia, var_script_case_init, do_ajax_form_tblnoticias_validate_dtanoticia_cb);
  } // do_ajax_form_tblnoticias_validate_dtanoticia

  function do_ajax_form_tblnoticias_validate_dtanoticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_validate_dtanoticia_cb

  // ---------- Validate strtitulo
  function do_ajax_form_tblnoticias_validate_strtitulo()
  {
    var nomeCampo_strtitulo = "strtitulo";
    var var_strtitulo = scAjaxGetFieldText(nomeCampo_strtitulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_validate_strtitulo(var_strtitulo, var_script_case_init, do_ajax_form_tblnoticias_validate_strtitulo_cb);
  } // do_ajax_form_tblnoticias_validate_strtitulo

  function do_ajax_form_tblnoticias_validate_strtitulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_validate_strtitulo_cb

  // ---------- Validate strnoticia
  function do_ajax_form_tblnoticias_validate_strnoticia()
  {
    var nomeCampo_strnoticia = "strnoticia";
    var var_strnoticia = scAjaxGetFieldEditorHtml(nomeCampo_strnoticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_validate_strnoticia(var_strnoticia, var_script_case_init, do_ajax_form_tblnoticias_validate_strnoticia_cb);
  } // do_ajax_form_tblnoticias_validate_strnoticia

  function do_ajax_form_tblnoticias_validate_strnoticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_validate_strnoticia_cb

  // ---------- Validate imgnoticia
  function do_ajax_form_tblnoticias_validate_imgnoticia()
  {
    var nomeCampo_imgnoticia = "imgnoticia";
    var var_imgnoticia = scAjaxGetFieldText(nomeCampo_imgnoticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_validate_imgnoticia(var_imgnoticia, var_script_case_init, do_ajax_form_tblnoticias_validate_imgnoticia_cb);
  } // do_ajax_form_tblnoticias_validate_imgnoticia

  function do_ajax_form_tblnoticias_validate_imgnoticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_validate_imgnoticia_cb

  // ---------- Validate bolfeed
  function do_ajax_form_tblnoticias_validate_bolfeed()
  {
    var nomeCampo_bolfeed = "bolfeed";
    var var_bolfeed = scAjaxGetFieldCheckbox(nomeCampo_bolfeed, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblnoticias_validate_bolfeed(var_bolfeed, var_script_case_init, do_ajax_form_tblnoticias_validate_bolfeed_cb);
  } // do_ajax_form_tblnoticias_validate_bolfeed

  function do_ajax_form_tblnoticias_validate_bolfeed_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bolfeed";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblnoticias_validate_bolfeed_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblnoticias_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblnoticias_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblnoticias_submit_form(var_intnoticiaid, var_dtanoticia, var_strtitulo, var_strnoticia, var_imgnoticia, var_bolfeed, var_imgnoticia_ul_name, var_imgnoticia_ul_type, var_imgnoticia_salva, var_imgnoticia_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblnoticias_submit_form_cb);
  } // do_ajax_form_tblnoticias_submit_form

  function do_ajax_form_tblnoticias_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblnoticias_submit_form_cb_after_alert);
  } // do_ajax_form_tblnoticias_submit_form_cb
  function do_ajax_form_tblnoticias_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblnoticias_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblnoticias_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblnoticias_navigate_form(var_intnoticiaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblnoticias_navigate_form_cb);
  } // do_ajax_form_tblnoticias_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblnoticias']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblnoticias_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblnoticias_navigate_form_cb_after_alert);
  } // do_ajax_form_tblnoticias_navigate_form_cb
  function do_ajax_form_tblnoticias_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblnoticias_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblnoticias_navigate_form_cb_after_alert
  function sc_hide_form_tblnoticias_form()
  {
