  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblpecas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate intpecaid
  function do_ajax_form_tblpecas_mob_validate_intpecaid()
  {
    var nomeCampo_intpecaid = "intpecaid";
    var var_intpecaid = scAjaxGetFieldHidden(nomeCampo_intpecaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_mob_validate_intpecaid(var_intpecaid, var_script_case_init, do_ajax_form_tblpecas_mob_validate_intpecaid_cb);
  } // do_ajax_form_tblpecas_mob_validate_intpecaid

  function do_ajax_form_tblpecas_mob_validate_intpecaid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intpecaid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_mob_validate_intpecaid_cb

  // ---------- Validate strpeca
  function do_ajax_form_tblpecas_mob_validate_strpeca()
  {
    var nomeCampo_strpeca = "strpeca";
    var var_strpeca = scAjaxGetFieldText(nomeCampo_strpeca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_mob_validate_strpeca(var_strpeca, var_script_case_init, do_ajax_form_tblpecas_mob_validate_strpeca_cb);
  } // do_ajax_form_tblpecas_mob_validate_strpeca

  function do_ajax_form_tblpecas_mob_validate_strpeca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strpeca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_mob_validate_strpeca_cb

  // ---------- Validate strcaracteristicas
  function do_ajax_form_tblpecas_mob_validate_strcaracteristicas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_mob_validate_strcaracteristicas(var_strcaracteristicas, var_script_case_init, do_ajax_form_tblpecas_mob_validate_strcaracteristicas_cb);
  } // do_ajax_form_tblpecas_mob_validate_strcaracteristicas

  function do_ajax_form_tblpecas_mob_validate_strcaracteristicas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_mob_validate_strcaracteristicas_cb

  // ---------- Validate imgpeca
  function do_ajax_form_tblpecas_mob_validate_imgpeca()
  {
    var nomeCampo_imgpeca = "imgpeca";
    var var_imgpeca = scAjaxGetFieldText(nomeCampo_imgpeca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_mob_validate_imgpeca(var_imgpeca, var_script_case_init, do_ajax_form_tblpecas_mob_validate_imgpeca_cb);
  } // do_ajax_form_tblpecas_mob_validate_imgpeca

  function do_ajax_form_tblpecas_mob_validate_imgpeca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imgpeca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_mob_validate_imgpeca_cb

  // ---------- Validate bolforalinha
  function do_ajax_form_tblpecas_mob_validate_bolforalinha()
  {
    var nomeCampo_bolforalinha = "bolforalinha";
    var var_bolforalinha = scAjaxGetFieldCheckbox(nomeCampo_bolforalinha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_mob_validate_bolforalinha(var_bolforalinha, var_script_case_init, do_ajax_form_tblpecas_mob_validate_bolforalinha_cb);
  } // do_ajax_form_tblpecas_mob_validate_bolforalinha

  function do_ajax_form_tblpecas_mob_validate_bolforalinha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_mob_validate_bolforalinha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblpecas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblpecas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intpecaid = scAjaxGetFieldHidden("intpecaid");
    var var_strpeca = scAjaxGetFieldText("strpeca");
    var var_strcaracteristicas = scAjaxGetFieldEditorHtml("strcaracteristicas");
    var var_imgpeca = scAjaxGetFieldText("imgpeca");
    var var_bolforalinha = scAjaxGetFieldCheckbox("bolforalinha", ";");
    var var_imgpeca_ul_name = scAjaxSpecCharProtect(document.F1.imgpeca_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imgpeca_ul_type = document.F1.imgpeca_ul_type.value;
    var var_imgpeca_salva = scAjaxSpecCharProtect(document.F1.imgpeca_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imgpeca_limpa = document.F1.imgpeca_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_tblpecas_mob_submit_form(var_intpecaid, var_strpeca, var_strcaracteristicas, var_imgpeca, var_bolforalinha, var_imgpeca_ul_name, var_imgpeca_ul_type, var_imgpeca_salva, var_imgpeca_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblpecas_mob_submit_form_cb);
  } // do_ajax_form_tblpecas_mob_submit_form

  function do_ajax_form_tblpecas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("intpecaid");
      scAjaxHideErrorDisplay("strpeca");
      scAjaxHideErrorDisplay("strcaracteristicas");
      scAjaxHideErrorDisplay("imgpeca");
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.imgpeca_limpa && document.F1.imgpeca_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("imgpeca", oImgTemp, "", "", "", "N");
      }
    document.F1.imgpeca_ul_name.value = '';
    document.F1.imgpeca_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblpecas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblpecas_mob_submit_form_cb
  function do_ajax_form_tblpecas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblpecas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblpecas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("imgpeca");
    scAjaxHideErrorDisplay("bolforalinha");
    var var_intpecaid = document.F2.intpecaid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblpecas_mob_navigate_form(var_intpecaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblpecas_mob_navigate_form_cb);
  } // do_ajax_form_tblpecas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblpecas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblpecas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblpecas_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.intpecaid.value = scAjaxGetKeyValue("intpecaid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblpecas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblpecas_mob_navigate_form_cb
  function do_ajax_form_tblpecas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblpecas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblpecas_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblpecas_mob_form()
  {
  ...
  ajax_field_list[0] = "intpecaid";
  ajax_field_list[1] = "strpeca";
  ajax_field_list[2] = "strcaracteristicas";
  ajax_field_list[3] = "imgpeca";
  ajax_field_list[4] = "bolforalinha";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "intpecaid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblpecas_fld_intpecaid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strpeca": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblpecas_fld_strpeca'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strcaracteristicas": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblpecas_fld_strcaracteristicas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imgpeca": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblpecas_fld_imgpeca'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bolforalinha": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblpecas_fld_bolforalinha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["intpecaid"][1] = "intpecaid";
  ajax_field_mult["strpeca"][1] = "strpeca";
  ajax_field_mult["strcaracteristicas"][1] = "strcaracteristicas";
  ajax_field_mult["imgpeca"][1] = "imgpeca";
  ajax_field_mult["bolforalinha"][1] = "bolforalinha";

  var ajax_field_id = {
    "intpecaid": new Array("hidden_field_label_intpecaid", "hidden_field_data_intpecaid"),
    "strpeca": new Array("hidden_field_label_strpeca", "hidden_field_data_strpeca"),
    "strcaracteristicas": new Array("hidden_field_label_strcaracteristicas", "hidden_field_data_strcaracteristicas"),
    "imgpeca": new Array("hidden_field_label_imgpeca", "hidden_field_data_imgpeca"),
