  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblpecas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate intpecaid
  function do_ajax_form_tblpecas_validate_intpecaid()
  {
    var nomeCampo_intpecaid = "intpecaid";
    var var_intpecaid = scAjaxGetFieldHidden(nomeCampo_intpecaid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_validate_intpecaid(var_intpecaid, var_script_case_init, do_ajax_form_tblpecas_validate_intpecaid_cb);
  } // do_ajax_form_tblpecas_validate_intpecaid

  function do_ajax_form_tblpecas_validate_intpecaid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_validate_intpecaid_cb

  // ---------- Validate strpeca
  function do_ajax_form_tblpecas_validate_strpeca()
  {
    var nomeCampo_strpeca = "strpeca";
    var var_strpeca = scAjaxGetFieldText(nomeCampo_strpeca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_validate_strpeca(var_strpeca, var_script_case_init, do_ajax_form_tblpecas_validate_strpeca_cb);
  } // do_ajax_form_tblpecas_validate_strpeca

  function do_ajax_form_tblpecas_validate_strpeca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strpeca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_validate_strpeca_cb

  // ---------- Validate strcaracteristicas
  function do_ajax_form_tblpecas_validate_strcaracteristicas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_validate_strcaracteristicas(var_strcaracteristicas, var_script_case_init, do_ajax_form_tblpecas_validate_strcaracteristicas_cb);
  } // do_ajax_form_tblpecas_validate_strcaracteristicas

  function do_ajax_form_tblpecas_validate_strcaracteristicas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_validate_strcaracteristicas_cb

  // ---------- Validate imgpeca
  function do_ajax_form_tblpecas_validate_imgpeca()
  {
    var nomeCampo_imgpeca = "imgpeca";
    var var_imgpeca = scAjaxGetFieldText(nomeCampo_imgpeca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_validate_imgpeca(var_imgpeca, var_script_case_init, do_ajax_form_tblpecas_validate_imgpeca_cb);
  } // do_ajax_form_tblpecas_validate_imgpeca

  function do_ajax_form_tblpecas_validate_imgpeca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imgpeca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_validate_imgpeca_cb

  // ---------- Validate bolforalinha
  function do_ajax_form_tblpecas_validate_bolforalinha()
  {
    var nomeCampo_bolforalinha = "bolforalinha";
    var var_bolforalinha = scAjaxGetFieldCheckbox(nomeCampo_bolforalinha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblpecas_validate_bolforalinha(var_bolforalinha, var_script_case_init, do_ajax_form_tblpecas_validate_bolforalinha_cb);
  } // do_ajax_form_tblpecas_validate_bolforalinha

  function do_ajax_form_tblpecas_validate_bolforalinha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblpecas_validate_bolforalinha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblpecas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblpecas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblpecas_submit_form(var_intpecaid, var_strpeca, var_strcaracteristicas, var_imgpeca, var_bolforalinha, var_imgpeca_ul_name, var_imgpeca_ul_type, var_imgpeca_salva, var_imgpeca_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblpecas_submit_form_cb);
  } // do_ajax_form_tblpecas_submit_form

  function do_ajax_form_tblpecas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblpecas_submit_form_cb_after_alert);
  } // do_ajax_form_tblpecas_submit_form_cb
  function do_ajax_form_tblpecas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblpecas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblpecas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblpecas_navigate_form(var_intpecaid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblpecas_navigate_form_cb);
  } // do_ajax_form_tblpecas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblpecas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblpecas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblpecas_navigate_form_cb_after_alert);
  } // do_ajax_form_tblpecas_navigate_form_cb
  function do_ajax_form_tblpecas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblpecas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblpecas_navigate_form_cb_after_alert
  function sc_hide_form_tblpecas_form()
  {
