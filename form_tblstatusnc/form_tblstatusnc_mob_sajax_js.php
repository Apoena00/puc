  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblstatusnc_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblstatusnc_mob_validate_intstatusncid()
  {
    var nomeCampo_intstatusncid = "intstatusncid";
    var var_intstatusncid = scAjaxGetFieldHidden(nomeCampo_intstatusncid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblstatusnc_mob_validate_intstatusncid(var_intstatusncid, var_script_case_init, do_ajax_form_tblstatusnc_mob_validate_intstatusncid_cb);
  } // do_ajax_form_tblstatusnc_mob_validate_intstatusncid

  function do_ajax_form_tblstatusnc_mob_validate_intstatusncid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblstatusnc_mob_validate_intstatusncid_cb

  // ---------- Validate strstatusnc
  function do_ajax_form_tblstatusnc_mob_validate_strstatusnc()
  {
    var nomeCampo_strstatusnc = "strstatusnc";
    var var_strstatusnc = scAjaxGetFieldText(nomeCampo_strstatusnc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblstatusnc_mob_validate_strstatusnc(var_strstatusnc, var_script_case_init, do_ajax_form_tblstatusnc_mob_validate_strstatusnc_cb);
  } // do_ajax_form_tblstatusnc_mob_validate_strstatusnc

  function do_ajax_form_tblstatusnc_mob_validate_strstatusnc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strstatusnc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblstatusnc_mob_validate_strstatusnc_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblstatusnc_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblstatusnc_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intstatusncid = scAjaxGetFieldHidden("intstatusncid");
    var var_strstatusnc = scAjaxGetFieldText("strstatusnc");
    ...
    scAjaxProcOn();
    x_ajax_form_tblstatusnc_mob_submit_form(var_intstatusncid, var_strstatusnc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblstatusnc_mob_submit_form_cb);
  } // do_ajax_form_tblstatusnc_mob_submit_form

  function do_ajax_form_tblstatusnc_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("strstatusnc");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblstatusnc_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblstatusnc_mob_submit_form_cb
  function do_ajax_form_tblstatusnc_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblstatusnc_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblstatusnc_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("intstatusncid");
    scAjaxHideErrorDisplay("strstatusnc");
    var var_intstatusncid = document.F2.intstatusncid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblstatusnc_mob_navigate_form(var_intstatusncid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblstatusnc_mob_navigate_form_cb);
  } // do_ajax_form_tblstatusnc_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblstatusnc_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblstatusnc_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblstatusnc_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.intstatusncid.value = scAjaxGetKeyValue("intstatusncid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblstatusnc_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblstatusnc_mob_navigate_form_cb
  function do_ajax_form_tblstatusnc_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblstatusnc_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblstatusnc_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblstatusnc_mob_form()
  {
  ...
  ajax_field_list[0] = "intstatusncid";
  ajax_field_list[1] = "strstatusnc";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "intstatusncid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblstatusnc_fld_intstatusncid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strstatusnc": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblstatusnc_fld_strstatusnc'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "strstatusnc": new Array()
  };
  ajax_field_mult["intstatusncid"][1] = "intstatusncid";
  ajax_field_mult["strstatusnc"][1] = "strstatusnc";

  var ajax_field_id = {
    "intstatusncid": new Array("hidden_field_label_intstatusncid", "hidden_field_data_intstatusncid"),
    "strstatusnc": new Array("hidden_field_label_strstatusnc", "hidden_field_data_strstatusnc")
  };
