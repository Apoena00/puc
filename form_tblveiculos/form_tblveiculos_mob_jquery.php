...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dtalancamento_hora' + iSeqRow).bind('blur', function() { sc_form_tblveiculos_dtalancamento_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_tblveiculos_dtalancamento_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_tblveiculos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dtalancamento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_tblveiculos_mob_validate_dtalancamento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_imgveiculo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_tblveiculos_mob_ul_save.php",
