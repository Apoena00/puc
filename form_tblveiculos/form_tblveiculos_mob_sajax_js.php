  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblveiculos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate intveiculoid
  function do_ajax_form_tblveiculos_mob_validate_intveiculoid()
  {
    var nomeCampo_intveiculoid = "intveiculoid";
    var var_intveiculoid = scAjaxGetFieldHidden(nomeCampo_intveiculoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_mob_validate_intveiculoid(var_intveiculoid, var_script_case_init, do_ajax_form_tblveiculos_mob_validate_intveiculoid_cb);
  } // do_ajax_form_tblveiculos_mob_validate_intveiculoid

  function do_ajax_form_tblveiculos_mob_validate_intveiculoid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "intveiculoid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_mob_validate_intveiculoid_cb

  // ---------- Validate strveiculo
  function do_ajax_form_tblveiculos_mob_validate_strveiculo()
  {
    var nomeCampo_strveiculo = "strveiculo";
    var var_strveiculo = scAjaxGetFieldText(nomeCampo_strveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_mob_validate_strveiculo(var_strveiculo, var_script_case_init, do_ajax_form_tblveiculos_mob_validate_strveiculo_cb);
  } // do_ajax_form_tblveiculos_mob_validate_strveiculo

  function do_ajax_form_tblveiculos_mob_validate_strveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strveiculo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_mob_validate_strveiculo_cb

  // ---------- Validate dtalancamento
  function do_ajax_form_tblveiculos_mob_validate_dtalancamento()
  {
    var nomeCampo_dtalancamento = "dtalancamento";
    var var_dtalancamento = scAjaxGetFieldText(nomeCampo_dtalancamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_mob_validate_dtalancamento(var_dtalancamento, var_script_case_init, do_ajax_form_tblveiculos_mob_validate_dtalancamento_cb);
  } // do_ajax_form_tblveiculos_mob_validate_dtalancamento

  function do_ajax_form_tblveiculos_mob_validate_dtalancamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dtalancamento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_mob_validate_dtalancamento_cb

  // ---------- Validate strcaracteristicas
  function do_ajax_form_tblveiculos_mob_validate_strcaracteristicas()
  {
    var nomeCampo_strcaracteristicas = "strcaracteristicas";
    var var_strcaracteristicas = scAjaxGetFieldEditorHtml(nomeCampo_strcaracteristicas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_mob_validate_strcaracteristicas(var_strcaracteristicas, var_script_case_init, do_ajax_form_tblveiculos_mob_validate_strcaracteristicas_cb);
  } // do_ajax_form_tblveiculos_mob_validate_strcaracteristicas

  function do_ajax_form_tblveiculos_mob_validate_strcaracteristicas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "strcaracteristicas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_mob_validate_strcaracteristicas_cb

  // ---------- Validate imgveiculo
  function do_ajax_form_tblveiculos_mob_validate_imgveiculo()
  {
    var nomeCampo_imgveiculo = "imgveiculo";
    var var_imgveiculo = scAjaxGetFieldText(nomeCampo_imgveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_mob_validate_imgveiculo(var_imgveiculo, var_script_case_init, do_ajax_form_tblveiculos_mob_validate_imgveiculo_cb);
  } // do_ajax_form_tblveiculos_mob_validate_imgveiculo

  function do_ajax_form_tblveiculos_mob_validate_imgveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imgveiculo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_mob_validate_imgveiculo_cb

  // ---------- Validate bolforalinha
  function do_ajax_form_tblveiculos_mob_validate_bolforalinha()
  {
    var nomeCampo_bolforalinha = "bolforalinha";
    var var_bolforalinha = scAjaxGetFieldCheckbox(nomeCampo_bolforalinha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_mob_validate_bolforalinha(var_bolforalinha, var_script_case_init, do_ajax_form_tblveiculos_mob_validate_bolforalinha_cb);
  } // do_ajax_form_tblveiculos_mob_validate_bolforalinha

  function do_ajax_form_tblveiculos_mob_validate_bolforalinha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bolforalinha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_mob_validate_bolforalinha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblveiculos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblveiculos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_intveiculoid = scAjaxGetFieldHidden("intveiculoid");
    var var_strveiculo = scAjaxGetFieldText("strveiculo");
    var var_dtalancamento = scAjaxGetFieldText("dtalancamento");
    var var_strcaracteristicas = scAjaxGetFieldEditorHtml("strcaracteristicas");
    var var_imgveiculo = scAjaxGetFieldText("imgveiculo");
    var var_bolforalinha = scAjaxGetFieldCheckbox("bolforalinha", ";");
    var var_imgveiculo_ul_name = scAjaxSpecCharProtect(document.F1.imgveiculo_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imgveiculo_ul_type = document.F1.imgveiculo_ul_type.value;
    var var_imgveiculo_salva = scAjaxSpecCharProtect(document.F1.imgveiculo_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_imgveiculo_limpa = document.F1.imgveiculo_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_tblveiculos_mob_submit_form(var_intveiculoid, var_strveiculo, var_dtalancamento, var_strcaracteristicas, var_imgveiculo, var_bolforalinha, var_imgveiculo_ul_name, var_imgveiculo_ul_type, var_imgveiculo_salva, var_imgveiculo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblveiculos_mob_submit_form_cb);
  } // do_ajax_form_tblveiculos_mob_submit_form

  function do_ajax_form_tblveiculos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("intveiculoid");
      scAjaxHideErrorDisplay("strveiculo");
      scAjaxHideErrorDisplay("dtalancamento");
      scAjaxHideErrorDisplay("strcaracteristicas");
      scAjaxHideErrorDisplay("imgveiculo");
      scAjaxHideErrorDisplay("bolforalinha");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.imgveiculo_limpa && document.F1.imgveiculo_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("imgveiculo", oImgTemp, "", "", "", "N");
      }
    document.F1.imgveiculo_ul_name.value = '';
    document.F1.imgveiculo_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblveiculos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tblveiculos_mob_submit_form_cb
  function do_ajax_form_tblveiculos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblveiculos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblveiculos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("imgveiculo");
    scAjaxHideErrorDisplay("bolforalinha");
    var var_intveiculoid = document.F2.intveiculoid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tblveiculos_mob_navigate_form(var_intveiculoid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblveiculos_mob_navigate_form_cb);
  } // do_ajax_form_tblveiculos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblveiculos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblveiculos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tblveiculos_mob_form();
    }
    scAjaxClearErrors()
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.intveiculoid.value = scAjaxGetKeyValue("intveiculoid");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblveiculos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tblveiculos_mob_navigate_form_cb
  function do_ajax_form_tblveiculos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblveiculos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tblveiculos_mob_navigate_form_cb_after_alert
  function sc_hide_form_tblveiculos_mob_form()
  {
  ...
  ajax_field_list[0] = "intveiculoid";
  ajax_field_list[1] = "strveiculo";
  ajax_field_list[2] = "dtalancamento";
  ajax_field_list[3] = "strcaracteristicas";
  ajax_field_list[4] = "imgveiculo";
  ajax_field_list[5] = "bolforalinha";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "intveiculoid": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblveiculos_fld_intveiculoid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strveiculo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblveiculos_fld_strveiculo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dtalancamento": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblveiculos_fld_dtalancamento'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "strcaracteristicas": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblveiculos_fld_strcaracteristicas'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imgveiculo": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblveiculos_fld_imgveiculo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bolforalinha": {"label": "<?php echo $this->Ini->Nm_lang['lang_tblveiculos_fld_bolforalinha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "intveiculoid": new Array(),
    "strveiculo": new Array(),
    "dtalancamento": new Array(),
    "strcaracteristicas": new Array(),
    "imgveiculo": new Array(),
    "bolforalinha": new Array()
  };
  ajax_field_mult["intveiculoid"][1] = "intveiculoid";
  ajax_field_mult["strveiculo"][1] = "strveiculo";
  ajax_field_mult["dtalancamento"][1] = "dtalancamento";
  ajax_field_mult["strcaracteristicas"][1] = "strcaracteristicas";
  ajax_field_mult["imgveiculo"][1] = "imgveiculo";
  ajax_field_mult["bolforalinha"][1] = "bolforalinha";

  var ajax_field_id = {
    "intveiculoid": new Array("hidden_field_label_intveiculoid", "hidden_field_data_intveiculoid"),
    "strveiculo": new Array("hidden_field_label_strveiculo", "hidden_field_data_strveiculo"),
    "dtalancamento": new Array("hidden_field_label_dtalancamento", "hidden_field_data_dtalancamento"),
    "strcaracteristicas": new Array("hidden_field_label_strcaracteristicas", "hidden_field_data_strcaracteristicas"),
    "imgveiculo": new Array("hidden_field_label_imgveiculo", "hidden_field_data_imgveiculo"),
    "bolforalinha": new Array("hidden_field_label_bolforalinha", "hidden_field_data_bolforalinha")
  };
