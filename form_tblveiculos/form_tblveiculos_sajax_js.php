  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tblveiculos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tblveiculos_validate_intveiculoid()
  {
    var nomeCampo_intveiculoid = "intveiculoid";
    var var_intveiculoid = scAjaxGetFieldHidden(nomeCampo_intveiculoid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_validate_intveiculoid(var_intveiculoid, var_script_case_init, do_ajax_form_tblveiculos_validate_intveiculoid_cb);
  } // do_ajax_form_tblveiculos_validate_intveiculoid

  function do_ajax_form_tblveiculos_validate_intveiculoid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_validate_intveiculoid_cb

  // ---------- Validate strveiculo
  function do_ajax_form_tblveiculos_validate_strveiculo()
  {
    var nomeCampo_strveiculo = "strveiculo";
    var var_strveiculo = scAjaxGetFieldText(nomeCampo_strveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_validate_strveiculo(var_strveiculo, var_script_case_init, do_ajax_form_tblveiculos_validate_strveiculo_cb);
  } // do_ajax_form_tblveiculos_validate_strveiculo

  function do_ajax_form_tblveiculos_validate_strveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_validate_strveiculo_cb

  // ---------- Validate dtalancamento
  function do_ajax_form_tblveiculos_validate_dtalancamento()
  {
    var nomeCampo_dtalancamento = "dtalancamento";
    var var_dtalancamento = scAjaxGetFieldText(nomeCampo_dtalancamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_validate_dtalancamento(var_dtalancamento, var_script_case_init, do_ajax_form_tblveiculos_validate_dtalancamento_cb);
  } // do_ajax_form_tblveiculos_validate_dtalancamento

  function do_ajax_form_tblveiculos_validate_dtalancamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_validate_dtalancamento_cb

  // ---------- Validate strcaracteristicas
  function do_ajax_form_tblveiculos_validate_strcaracteristicas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_validate_strcaracteristicas(var_strcaracteristicas, var_script_case_init, do_ajax_form_tblveiculos_validate_strcaracteristicas_cb);
  } // do_ajax_form_tblveiculos_validate_strcaracteristicas

  function do_ajax_form_tblveiculos_validate_strcaracteristicas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_validate_strcaracteristicas_cb

  // ---------- Validate imgveiculo
  function do_ajax_form_tblveiculos_validate_imgveiculo()
  {
    var nomeCampo_imgveiculo = "imgveiculo";
    var var_imgveiculo = scAjaxGetFieldText(nomeCampo_imgveiculo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_validate_imgveiculo(var_imgveiculo, var_script_case_init, do_ajax_form_tblveiculos_validate_imgveiculo_cb);
  } // do_ajax_form_tblveiculos_validate_imgveiculo

  function do_ajax_form_tblveiculos_validate_imgveiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_validate_imgveiculo_cb

  // ---------- Validate bolforalinha
  function do_ajax_form_tblveiculos_validate_bolforalinha()
  {
    var nomeCampo_bolforalinha = "bolforalinha";
    var var_bolforalinha = scAjaxGetFieldCheckbox(nomeCampo_bolforalinha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tblveiculos_validate_bolforalinha(var_bolforalinha, var_script_case_init, do_ajax_form_tblveiculos_validate_bolforalinha_cb);
  } // do_ajax_form_tblveiculos_validate_bolforalinha

  function do_ajax_form_tblveiculos_validate_bolforalinha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tblveiculos_validate_bolforalinha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tblveiculos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tblveiculos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tblveiculos_submit_form(var_intveiculoid, var_strveiculo, var_dtalancamento, var_strcaracteristicas, var_imgveiculo, var_bolforalinha, var_imgveiculo_ul_name, var_imgveiculo_ul_type, var_imgveiculo_salva, var_imgveiculo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tblveiculos_submit_form_cb);
  } // do_ajax_form_tblveiculos_submit_form

  function do_ajax_form_tblveiculos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tblveiculos_submit_form_cb_after_alert);
  } // do_ajax_form_tblveiculos_submit_form_cb
  function do_ajax_form_tblveiculos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tblveiculos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tblveiculos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tblveiculos_navigate_form(var_intveiculoid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tblveiculos_navigate_form_cb);
  } // do_ajax_form_tblveiculos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tblveiculos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tblveiculos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tblveiculos_navigate_form_cb_after_alert);
  } // do_ajax_form_tblveiculos_navigate_form_cb
  function do_ajax_form_tblveiculos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scQSInit = true;
...
{
?>
    do_ajax_form_tblveiculos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tblveiculos_navigate_form_cb_after_alert
  function sc_hide_form_tblveiculos_form()
  {
