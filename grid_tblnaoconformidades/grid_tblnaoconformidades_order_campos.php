...
<?php
   ...
   $Ord_Cmp = new grid_tblnaoconformidades_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tblnaoconformidades_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['intnaoconformidadeid'] = "on";
   $tab_def_campos['intnaoconformidadeid'] = "intnaoconformidadeid";
   $tab_converte["intnaoconformidadeid"]   = "intnaoconformidadeid";
   $tab_labels["intnaoconformidadeid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["intnaoconformidadeid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["intnaoconformidadeid"] : "" . $this->Nm_lang['lang_tblnaoconformidades_fld_intnaoconformidadeid'] . "";
   $tab_ger_campos['dtaidentificacao'] = "on";
   $tab_def_campos['dtaidentificacao'] = "dtaidentificacao";
   $tab_converte["dtaidentificacao"]   = "dtaidentificacao";
   $tab_labels["dtaidentificacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["dtaidentificacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["dtaidentificacao"] : "" . $this->Nm_lang['lang_tblnaoconformidades_fld_dtaidentificacao'] . "";
   $tab_ger_campos['strnaoconformidade'] = "on";
   $tab_def_campos['strnaoconformidade'] = "strnaoconformidade";
   $tab_converte["strnaoconformidade"]   = "strnaoconformidade";
   $tab_labels["strnaoconformidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["strnaoconformidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["strnaoconformidade"] : "" . $this->Nm_lang['lang_tblnaoconformidades_fld_strnaoconformidade'] . "";
   $tab_ger_campos['strdescricao'] = "on";
   $tab_def_campos['strdescricao'] = "strdescricao";
   $tab_converte["strdescricao"]   = "strdescricao";
   $tab_labels["strdescricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["strdescricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["strdescricao"] : "" . $this->Nm_lang['lang_tblnaoconformidades_fld_strdescricao'] . "";
   $tab_ger_campos['intstatusncid'] = "on";
   $tab_def_campos['intstatusncid'] = "intstatusncid";
   $tab_converte["intstatusncid"]   = "intstatusncid";
   $tab_labels["intstatusncid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["intstatusncid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["intstatusncid"] : "" . $this->Nm_lang['lang_tblnaoconformidades_fld_intstatusncid'] . "";
   $tab_ger_campos['veiculos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['veiculos'] = "veiculos";
       $tab_converte["veiculos"]   = "veiculos";
   }
   else
   {
       $tab_def_campos['veiculos'] = "";
       $tab_converte[""]   = "veiculos";
   }
   $tab_labels["veiculos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["veiculos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["veiculos"] : "Veículos";
   $tab_ger_campos['pecas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pecas'] = "pecas";
       $tab_converte["pecas"]   = "pecas";
   }
   else
   {
       $tab_def_campos['pecas'] = "";
       $tab_converte[""]   = "pecas";
   }
   $tab_labels["pecas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["pecas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['labels']["pecas"] : "Peças";
   $tab_ger_campos['veiculos'] = "none";
   $tab_ger_campos['pecas'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_tblnaoconformidades'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tblnaoconformidades_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tblnaoconformidades']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
