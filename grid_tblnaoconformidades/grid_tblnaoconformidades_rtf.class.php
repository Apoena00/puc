...
class grid_tblnaoconformidades_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tblnaoconformidades.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['rtf_name']);
      }
   ...
   function NM_export_dtaidentificacao()
   {
         ...
         $this->dtaidentificacao = str_replace('>', '&gt;', $this->dtaidentificacao);
         $this->Texto_tag .= "<td>" . $this->dtaidentificacao . "</td>\r\n";
   }
   //----- strnaoconformidade
   function NM_export_strnaoconformidade()
   {
         ...
         $this->strnaoconformidade = str_replace('<', '&lt;', $this->strnaoconformidade);
         $this->strnaoconformidade = str_replace('>', '&gt;', $this->strnaoconformidade);
         $this->Texto_tag .= "<td>" . $this->strnaoconformidade . "</td>\r\n";
   }
   //----- strdescricao
   function NM_export_strdescricao()
   {
         ...
         $this->strdescricao = str_replace('<', '&lt;', $this->strdescricao);
         $this->strdescricao = str_replace('>', '&gt;', $this->strdescricao);
         $this->Texto_tag .= "<td>" . $this->strdescricao . "</td>\r\n";
   }
   //----- intstatusncid
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_tblnaoconformidades'] ?> :: RTF</TITLE>
