...
class grid_tblnaoconformidades_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_label']))
      {
          $this->Xml_tag_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_label'];
          $this->New_Format    = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_return']);
          if ($this->Tem_xml_res) {
      ...
      $this->Arquivo     .= "_grid_tblnaoconformidades";
      $this->Arquivo_view = $this->Arquivo . "_view.xml";
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_tblnaoconformidades.xml";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_tblnaoconformidades>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_tblnaoconformidades";
      ...
      { 
          ...
          { 
              ...
              $this->Res = new grid_tblnaoconformidades_res_xml();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_res_grid'] = true;
              $this->Res->monta_xml();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_res_file']['xml'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_res_file']['xml']);
              }
              if ($this->Grava_view)
              {
                  $str_zip    = "";
                  ...
                  { 
                      $str_zip   = "";
                      $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_res_file']['view'];
                      $Arq_input = (FALSE !== strpos($Arq_res, ' ')) ? " \"" . $Arq_res . "\"" :  $Arq_res;
                      if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                      {
                          $str_zip = "zip.exe " . strtoupper($Parm_pass) . " -j -u " . $this->Xml_password . " " . $Zip_f . " " . $Arq_input;
                      ...
                      unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_res_file']['view']);
                  }
              } 
              else 
              {
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_res_grid']);
          } 
      }
   ...
   function NM_export_dtaidentificacao()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->dtaidentificacao))
         {
          ...
          {
              $SC_Label = "dtaidentificacao"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->dtaidentificacao) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->dtaidentificacao) . "\"";
         }
   }
   //----- strnaoconformidade
   function NM_export_strnaoconformidade()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->strnaoconformidade))
         {
          ...
          {
              $SC_Label = "strnaoconformidade"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->strnaoconformidade) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->strnaoconformidade) . "\"";
         }
   }
   //----- strdescricao
   function NM_export_strdescricao()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->strdescricao))
         {
          ...
          {
              $SC_Label = "strdescricao"; 
          }
          $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->strdescricao) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->strdescricao) . "\"";
         }
   }
   //----- intstatusncid
   ...
   function NM_export_veiculos()
   {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncveiculos']['embutida']  = true;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncveiculos']['xml_label'] = $this->Xml_tag_label;
                  $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xml?@?";
                  $detailParameters = array();
                  $detailParameters[] = "intnaoconformidadeid?#?" . str_replace("'", "@aspass@", $this->Orig_intnaoconformidadeid);
                  ...
                  $this->clear_tag($SC_Label); 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncveiculos']['embutida_tit'] = "veiculos";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncveiculos']['embutida_xml_format'] = $this->New_Format;
   ...
   function NM_export_pecas()
   {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncpecas']['embutida']  = true;
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncpecas']['xml_label'] = $this->Xml_tag_label;
                  $GLOBALS["script_case_init"] = $this->Ini->sc_page;
                  $GLOBALS["nmgp_parms"] = "nmgp_opcao?#?xml?@?";
                  $detailParameters = array();
                  $detailParameters[] = "intnaoconformidadeid?#?" . str_replace("'", "@aspass@", $this->Orig_intnaoconformidadeid);
                  ...
                  $this->clear_tag($SC_Label); 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncpecas']['embutida_tit'] = "pecas";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblncpecas']['embutida_xml_format'] = $this->New_Format;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_tblnaoconformidades'] ?> :: XML</TITLE>
...
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblnaoconformidades']['xml_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
