...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["tcc_puc_____grid_tblncpecas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["tcc_puc_____grid_tblncpecas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tblncpecas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tblncpecas']['embutida_filho'] as $ind => $sc_init)
          {
