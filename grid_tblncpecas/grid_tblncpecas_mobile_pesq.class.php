...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "intnaoconformidadeid";$Nm_numeric[] = "intpecaid";$Nm_numeric[] = "intstatusncid";$Nm_numeric[] = "intnaoconformidadeid";$Nm_numeric[] = "intpecaid";$Nm_numeric[] = "intstatusncid";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_intpecaid_cond" name="intpecaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_intpecaid'), this, 'intpecaid')">
      ...
      <br><span id="id_hide_intpecaid"  <?php echo $str_hide_intpecaid?>><INPUT  type="text" id="SC_intpecaid" name="intpecaid" value="<?php echo NM_encode_input($intpecaid) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
