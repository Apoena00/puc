<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tblncveiculos']['sc_process_barr'] = true;
require_once('../grid_tblncveiculos/index.php');
unset($_SESSION['scriptcase']['grid_tblncveiculos']['sc_process_barr']);
$ExportCtrl = new grid_tblncveiculos_export_control;
$ExportCtrl->Export_barr();

class grid_tblncveiculos_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_tblncveiculos'] ?> :: Excel</TITLE>
