...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "intnaoconformidadeid";$Nm_numeric[] = "intveiculoid";$Nm_numeric[] = "intstatusncid";$Nm_numeric[] = "intnaoconformidadeid";$Nm_numeric[] = "intveiculoid";$Nm_numeric[] = "intstatusncid";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_intstatusncid_cond" name="intstatusncid_cond" onChange="nm_campos_between(document.getElementById('id_vis_intstatusncid'), this, 'intstatusncid')">
      ...
      <br><span id="id_hide_intstatusncid"  <?php echo $str_hide_intstatusncid?>><INPUT  type="text" id="SC_intstatusncid" name="intstatusncid" value="<?php echo NM_encode_input($intstatusncid) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_intveiculoid_cond" name="intveiculoid_cond" onChange="nm_campos_between(document.getElementById('id_vis_intveiculoid'), this, 'intveiculoid')">
      ...
      <br><span id="id_hide_intveiculoid"  <?php echo $str_hide_intveiculoid?>><INPUT  type="text" id="SC_intveiculoid" name="intveiculoid" value="<?php echo NM_encode_input($intveiculoid) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_strobservacao_cond" name="strobservacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_strobservacao'), this, 'strobservacao')">
      ...
      <br><span id="id_hide_strobservacao"  <?php echo $str_hide_strobservacao?>><?php
      if ($strobservacao != "")
      {
      $strobservacao_look = substr($this->Db->qstr($strobservacao), 1, -1); 
      $nmgp_def_dados = array(); 
