...
<?php
   ...
   $Ord_Cmp = new grid_tblncveiculos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tblncveiculos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['intveiculoid'] = "intveiculoid";
   $tab_converte["intveiculoid"]   = "intveiculoid";
   $tab_labels["intveiculoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['labels']["intveiculoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['labels']["intveiculoid"] : "" . $this->Nm_lang['lang_tblncveiculos_fld_intveiculoid'] . "";
   $tab_ger_campos['strobservacao'] = "on";
   $tab_def_campos['strobservacao'] = "strobservacao";
   $tab_converte["strobservacao"]   = "strobservacao";
   $tab_labels["strobservacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['labels']["strobservacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['labels']["strobservacao"] : "" . $this->Nm_lang['lang_tblncveiculos_fld_strobservacao'] . "";
   $tab_ger_campos['intstatusncid'] = "on";
   $tab_def_campos['intstatusncid'] = "intstatusncid";
   $tab_converte["intstatusncid"]   = "intstatusncid";
   $tab_labels["intstatusncid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['labels']["intstatusncid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['labels']["intstatusncid"] : "" . $this->Nm_lang['lang_tblncveiculos_fld_intstatusncid'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tblncveiculos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tblncveiculos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
