<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tblnoticias']['sc_process_barr'] = true;
require_once('../grid_tblnoticias/index.php');
unset($_SESSION['scriptcase']['grid_tblnoticias']['sc_process_barr']);
$ExportCtrl = new grid_tblnoticias_export_control;
$ExportCtrl->Export_barr();

class grid_tblnoticias_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_tblnoticias'] ?> :: Excel</TITLE>
