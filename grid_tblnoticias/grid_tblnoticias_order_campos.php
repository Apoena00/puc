...
<?php
   ...
   $Ord_Cmp = new grid_tblnoticias_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tblnoticias_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['intnoticiaid'] = "intnoticiaid";
   $tab_converte["intnoticiaid"]   = "intnoticiaid";
   $tab_labels["intnoticiaid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["intnoticiaid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["intnoticiaid"] : "" . $this->Nm_lang['lang_tblnoticias_fld_intnoticiaid'] . "";
   $tab_ger_campos['dtanoticia'] = "on";
   $tab_def_campos['dtanoticia'] = "dtanoticia";
   $tab_converte["dtanoticia"]   = "dtanoticia";
   $tab_labels["dtanoticia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["dtanoticia"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["dtanoticia"] : "" . $this->Nm_lang['lang_tblnoticias_fld_dtanoticia'] . "";
   $tab_ger_campos['strtitulo'] = "on";
   $tab_def_campos['strtitulo'] = "strtitulo";
   $tab_converte["strtitulo"]   = "strtitulo";
   $tab_labels["strtitulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["strtitulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["strtitulo"] : "" . $this->Nm_lang['lang_tblnoticias_fld_strtitulo'] . "";
   $tab_ger_campos['strnoticia'] = "on";
   $tab_def_campos['strnoticia'] = "strnoticia";
   $tab_converte["strnoticia"]   = "strnoticia";
   $tab_labels["strnoticia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["strnoticia"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["strnoticia"] : "" . $this->Nm_lang['lang_tblnoticias_fld_strnoticia'] . "";
   $tab_ger_campos['imgnoticia'] = "on";
   $tab_def_campos['imgnoticia'] = "imgnoticia";
   $tab_converte["imgnoticia"]   = "imgnoticia";
   $tab_labels["imgnoticia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["imgnoticia"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["imgnoticia"] : "" . $this->Nm_lang['lang_tblnoticias_fld_imgnoticia'] . "";
   $tab_ger_campos['bolfeed'] = "on";
   $tab_def_campos['bolfeed'] = "bolfeed";
   $tab_converte["bolfeed"]   = "bolfeed";
   $tab_labels["bolfeed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["bolfeed"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['labels']["bolfeed"] : "" . $this->Nm_lang['lang_tblnoticias_fld_bolfeed'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tblnoticias_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tblnoticias']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
