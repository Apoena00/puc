<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tblpecas']['sc_process_barr'] = true;
require_once('../grid_tblpecas/index.php');
unset($_SESSION['scriptcase']['grid_tblpecas']['sc_process_barr']);
$ExportCtrl = new grid_tblpecas_export_control;
$ExportCtrl->Export_barr();

class grid_tblpecas_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_tblpecas'] ?> :: Excel</TITLE>
