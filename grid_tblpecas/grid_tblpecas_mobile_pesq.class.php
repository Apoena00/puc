...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "intpecaid";$Nm_numeric[] = "bolforalinha";$Nm_numeric[] = "intpecaid";$Nm_numeric[] = "bolforalinha";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_imgpeca_cond" name="imgpeca_cond" onChange="nm_campos_between(document.getElementById('id_vis_imgpeca'), this, 'imgpeca')">
      ...
      <br><span id="id_hide_imgpeca"  <?php echo $str_hide_imgpeca?>><?php
      if ($imgpeca != "")
      {
      $imgpeca_look = substr($this->Db->qstr($imgpeca), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_intpecaid_cond" name="intpecaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_intpecaid'), this, 'intpecaid')">
      ...
      <br><span id="id_hide_intpecaid"  <?php echo $str_hide_intpecaid?>><INPUT  type="text" id="SC_intpecaid" name="intpecaid" value="<?php echo NM_encode_input($intpecaid) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_strpeca_cond" name="strpeca_cond" onChange="nm_campos_between(document.getElementById('id_vis_strpeca'), this, 'strpeca')">
      ...
      <br><span id="id_hide_strpeca"  <?php echo $str_hide_strpeca?>><?php
      if ($strpeca != "")
      {
      $strpeca_look = substr($this->Db->qstr($strpeca), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_strcaracteristicas_cond" name="strcaracteristicas_cond" onChange="nm_campos_between(document.getElementById('id_vis_strcaracteristicas'), this, 'strcaracteristicas')">
      ...
      <br><span id="id_hide_strcaracteristicas"  <?php echo $str_hide_strcaracteristicas?>><INPUT  type="text" id="SC_strcaracteristicas" name="strcaracteristicas" value="<?php echo NM_encode_input($strcaracteristicas) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
