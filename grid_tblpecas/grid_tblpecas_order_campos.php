...
<?php
   ...
   $Ord_Cmp = new grid_tblpecas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tblpecas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['strpeca'] = "strpeca";
   $tab_converte["strpeca"]   = "strpeca";
   $tab_labels["strpeca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["strpeca"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["strpeca"] : "" . $this->Nm_lang['lang_tblpecas_fld_strpeca'] . "";
   ...
   $tab_labels["strcaracteristicas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["strcaracteristicas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["strcaracteristicas"] : "" . $this->Nm_lang['lang_tblpecas_fld_strcaracteristicas'] . "";
   $tab_ger_campos['imgpeca'] = "on";
   $tab_def_campos['imgpeca'] = "imgpeca";
   $tab_converte["imgpeca"]   = "imgpeca";
   $tab_labels["imgpeca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["imgpeca"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["imgpeca"] : "" . $this->Nm_lang['lang_tblpecas_fld_imgpeca'] . "";
   $tab_ger_campos['bolforalinha'] = "on";
   $tab_def_campos['bolforalinha'] = "bolforalinha";
   $tab_converte["bolforalinha"]   = "bolforalinha";
   $tab_labels["bolforalinha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["bolforalinha"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['labels']["bolforalinha"] : "" . $this->Nm_lang['lang_tblpecas_fld_bolforalinha'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tblpecas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tblpecas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
