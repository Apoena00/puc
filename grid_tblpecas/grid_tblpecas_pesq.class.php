...
class grid_tblpecas_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tblpecas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tblpecas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tblpecas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_imgpeca')
      {
          $imgpeca = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_imgpeca($imgpeca);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_strpeca')
      {
          $strpeca = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_strpeca($strpeca);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_tblpecas'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tblpecas/grid_tblpecas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tblpecas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tblpecas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tblpecas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tblpecas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tblpecas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_imgpeca_cond#NMF#' + search_get_sel_txt('SC_imgpeca_cond') + '@NMF@';
  str_out += 'SC_imgpeca#NMF#' + search_get_text('SC_imgpeca') + '@NMF@';
  str_out += 'id_ac_imgpeca#NMF#' + search_get_text('id_ac_imgpeca') + '@NMF@';
  ...
  str_out += 'SC_strpeca_cond#NMF#' + search_get_sel_txt('SC_strpeca_cond') + '@NMF@';
  str_out += 'SC_strpeca#NMF#' + search_get_text('SC_strpeca') + '@NMF@';
  str_out += 'id_ac_strpeca#NMF#' + search_get_text('id_ac_strpeca') + '@NMF@';
   ...
   $("#id_ac_strpeca").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_strpeca",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_strpeca").val( $(this).val() );
       }
     }
   });
   $("#id_ac_imgpeca").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_imgpeca",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_tblpecas'] ?></div>
...
<?php
   ...
   {
      global 
             $imgpeca_cond, $imgpeca, $imgpeca_autocomp,
             $intpecaid_cond, $intpecaid,
             $strpeca_cond, $strpeca, $strpeca_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
          $imgpeca = "";
          $intpecaid = "";
          $strpeca = "";
      ...
      { 
          ...
          $imgpeca = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['imgpeca']; 
          $imgpeca_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['imgpeca_cond']; 
          $intpecaid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['intpecaid']; 
          $intpecaid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['intpecaid_cond']; 
          $strpeca = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strpeca']; 
          $strpeca_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strpeca_cond']; 
          $strcaracteristicas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strcaracteristicas']; 
          $strcaracteristicas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strcaracteristicas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['NM_operador']; 
      ...
      if (!isset($imgpeca_cond) || empty($imgpeca_cond))
      {
         $imgpeca_cond = "qp";
      }
      ...
      if (!isset($strpeca_cond) || empty($strpeca_cond))
      {
         $strpeca_cond = "qp";
      }
      ...
      $str_hide_imgpeca = (in_array($imgpeca_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_intpecaid = (in_array($intpecaid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_strpeca = (in_array($strpeca_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_strcaracteristicas = (in_array($strcaracteristicas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($imgpeca) || $imgpeca == "")
      {
          $imgpeca = "";
      }
      if (isset($imgpeca) && !empty($imgpeca))
      {
         $tmp_pos = strpos($imgpeca, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $imgpeca = substr($imgpeca, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($strpeca) || $strpeca == "")
      {
          $strpeca = "";
      }
      if (isset($strpeca) && !empty($strpeca))
      {
         $tmp_pos = strpos($strpeca, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $strpeca = substr($strpeca, 0, $tmp_pos);
         }
      }
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['imgpeca'])) ? $this->New_label['imgpeca'] : "" . $this->Ini->Nm_lang['lang_tblpecas_fld_imgpeca'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_imgpeca_cond" name="imgpeca_cond" onChange="nm_campos_between(document.getElementById('id_vis_imgpeca'), this, 'imgpeca')">
       <OPTION value="qp" <?php if ("qp" == $imgpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $imgpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $imgpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $imgpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_imgpeca" <?php echo $str_hide_imgpeca?> valign="top">
 ...
 $nmgp_tab_label .= "imgpeca?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($imgpeca != "")
      ...
      {
          $sAutocompValue = $imgpeca;
      }
?>
<INPUT  type="text" id="SC_imgpeca" name="imgpeca" value="<?php echo NM_encode_input($imgpeca) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_imgpeca" name="imgpeca_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['intpecaid'])) ? $this->New_label['intpecaid'] : "" . $this->Ini->Nm_lang['lang_tblpecas_fld_intpecaid'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_intpecaid_cond" name="intpecaid_cond" onChange="nm_campos_between(document.getElementById('id_vis_intpecaid'), this, 'intpecaid')">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_intpecaid" name="intpecaid" value="<?php echo NM_encode_input($intpecaid) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['strpeca'])) ? $this->New_label['strpeca'] : "" . $this->Ini->Nm_lang['lang_tblpecas_fld_strpeca'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_strpeca_cond" name="strpeca_cond" onChange="nm_campos_between(document.getElementById('id_vis_strpeca'), this, 'strpeca')">
       <OPTION value="qp" <?php if ("qp" == $strpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $strpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $strpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $strpeca_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_strpeca" <?php echo $str_hide_strpeca?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['strpeca'])) ? $this->New_label['strpeca'] : "" . $this->Ini->Nm_lang['lang_tblpecas_fld_strpeca'] . "";
 $nmgp_tab_label .= "strpeca?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($strpeca != "")
      ...
      {
          $sAutocompValue = $strpeca;
      }
?>
<INPUT  type="text" id="SC_strpeca" name="strpeca" value="<?php echo NM_encode_input($strpeca) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_strpeca" name="strpeca_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['strcaracteristicas'])) ? $this->New_label['strcaracteristicas'] : "" . $this->Ini->Nm_lang['lang_tblpecas_fld_strcaracteristicas'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_strcaracteristicas_cond" name="strcaracteristicas_cond" onChange="nm_campos_between(document.getElementById('id_vis_strcaracteristicas'), this, 'strcaracteristicas')">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_strcaracteristicas" name="strcaracteristicas" value="<?php echo NM_encode_input($strcaracteristicas) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_tblpecas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tblpecas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tblpecas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_imgpeca'), document.F1.imgpeca_cond, 'imgpeca');
   document.F1.imgpeca.value = "";
   document.F1.imgpeca_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_strpeca'), document.F1.strpeca_cond, 'strpeca');
   document.F1.strpeca.value = "";
   document.F1.strpeca_autocomp.value = "";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_imgpeca_cond'] = 'cond';
      $tp_fields['SC_imgpeca'] = 'text_aut';
      $tp_fields['id_ac_imgpeca'] = 'text_aut';
      $tp_fields['SC_intpecaid_cond'] = 'cond';
      $tp_fields['SC_intpecaid'] = 'text';
      $tp_fields['SC_strpeca_cond'] = 'cond';
      $tp_fields['SC_strpeca'] = 'text_aut';
      $tp_fields['id_ac_strpeca'] = 'text_aut';
   ...
   {
      global $imgpeca_cond, $imgpeca, $imgpeca_autocomp,
             $intpecaid_cond, $intpecaid,
             $strpeca_cond, $strpeca, $strpeca_autocomp,
             $strcaracteristicas_cond, $strcaracteristicas, $nmgp_tab_label;

      $C_formatado = true;
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq'] = array();
      if (!empty($imgpeca_autocomp) && empty($imgpeca))
      {
          $imgpeca = $imgpeca_autocomp;
      }
      if (!empty($strpeca_autocomp) && empty($strpeca))
      {
          $strpeca = $strpeca_autocomp;
      }
      $imgpeca_cond_salva = $imgpeca_cond; 
      if (!isset($imgpeca_input_2) || $imgpeca_input_2 == "")
      {
          $imgpeca_input_2 = $imgpeca;
      }
      ...
      $strpeca_cond_salva = $strpeca_cond; 
      if (!isset($strpeca_input_2) || $strpeca_input_2 == "")
      {
          $strpeca_input_2 = $strpeca;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['imgpeca'] = $imgpeca; 
      if (is_array($imgpeca) && !empty($imgpeca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0] = $imgpeca;
      }
      elseif ($imgpeca_cond_salva == "nu" || $imgpeca_cond_salva == "nn" || $imgpeca_cond_salva == "ep" || $imgpeca_cond_salva == "ne" ||  !empty($imgpeca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0][0] = $imgpeca;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['imgpeca_cond'] = $imgpeca_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['cmp'] = "imgpeca"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['opc'] = $imgpeca_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq']['imgpeca'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['intpecaid'] = $intpecaid; 
      if (is_array($intpecaid) && !empty($intpecaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0] = $intpecaid;
      }
      elseif ($intpecaid_cond_salva == "nu" || $intpecaid_cond_salva == "nn" || $intpecaid_cond_salva == "ep" || $intpecaid_cond_salva == "ne" ||  !empty($intpecaid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0][0] = $intpecaid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['intpecaid_cond'] = $intpecaid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['cmp'] = "intpecaid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['opc'] = $intpecaid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq']['intpecaid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strpeca'] = $strpeca; 
      if (is_array($strpeca) && !empty($strpeca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0] = $strpeca;
      }
      elseif ($strpeca_cond_salva == "nu" || $strpeca_cond_salva == "nn" || $strpeca_cond_salva == "ep" || $strpeca_cond_salva == "ne" ||  !empty($strpeca))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0][0] = $strpeca;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strpeca_cond'] = $strpeca_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['cmp'] = "strpeca"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['opc'] = $strpeca_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq']['strpeca'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strcaracteristicas'] = $strcaracteristicas; 
      if (is_array($strcaracteristicas) && !empty($strcaracteristicas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0] = $strcaracteristicas;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['val'][0][0] = $strcaracteristicas;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['strcaracteristicas_cond'] = $strcaracteristicas_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['cmp'] = "strcaracteristicas"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid]['opc'] = $strcaracteristicas_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['grid_pesq']['strcaracteristicas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['imgpeca'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['imgpeca'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['imgpeca'] = $imgpeca;
      }
      $Conteudo = $intpecaid;
      if (strtoupper($intpecaid_cond) != "II" && strtoupper($intpecaid_cond) != "QP" && strtoupper($intpecaid_cond) != "NP" && strtoupper($intpecaid_cond) != "IN") 
      { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['strpeca'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['strpeca'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['strpeca'] = $strpeca;
      }
      ...
      if (isset($imgpeca) || $imgpeca_cond == "nu" || $imgpeca_cond == "nn" || $imgpeca_cond == "ep" || $imgpeca_cond == "ne")
      {
         $this->monta_condicao("imgpeca", $imgpeca_cond, $imgpeca, "", "imgpeca");
      }
      ...
      //----- $strpeca
      $this->Date_part = false;
      if (isset($strpeca) || $strpeca_cond == "nu" || $strpeca_cond == "nn" || $strpeca_cond == "ep" || $strpeca_cond == "ne")
      {
         $this->monta_condicao("strpeca", $strpeca_cond, $strpeca, "", "strpeca");
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['cond_pesq'] .= $this->NM_operador;
