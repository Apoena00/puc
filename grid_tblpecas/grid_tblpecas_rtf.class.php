...
class grid_tblpecas_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_tblpecas.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['rtf_name']);
      }
   ...
   function NM_export_strpeca()
   {
         ...
         $this->strpeca = str_replace('<', '&lt;', $this->strpeca);
         $this->strpeca = str_replace('>', '&gt;', $this->strpeca);
         $this->Texto_tag .= "<td>" . $this->strpeca . "</td>\r\n";
   }
   //----- strcaracteristicas
   ...
   {
         if (!NM_is_utf8($this->imgpeca))
         {
             $this->imgpeca = sc_convert_encoding($this->imgpeca, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->imgpeca = str_replace('<', '&lt;', $this->imgpeca);
         $this->imgpeca = str_replace('>', '&gt;', $this->imgpeca);
         $this->Texto_tag .= "<td>" . $this->imgpeca . "</td>\r\n";
   }
   //----- bolforalinha
   ...
   function NM_export_intpecaid()
   {
         ...
         $this->intpecaid = str_replace('<', '&lt;', $this->intpecaid);
         $this->intpecaid = str_replace('>', '&gt;', $this->intpecaid);
         $this->Texto_tag .= "<td>" . $this->intpecaid . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tblpecas']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_tblpecas'] ?> :: RTF</TITLE>
