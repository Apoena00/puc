...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["tcc_puc_____grid_tblstatusnc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["tcc_puc_____grid_tblstatusnc"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tblstatusnc'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tblstatusnc']['embutida_filho'] as $ind => $sc_init)
          {
