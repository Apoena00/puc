...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "intstatusncid";$Nm_numeric[] = "intstatusncid";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_strstatusnc_cond" name="strstatusnc_cond" onChange="nm_campos_between(document.getElementById('id_vis_strstatusnc'), this, 'strstatusnc')">
      ...
      <br><span id="id_hide_strstatusnc"  <?php echo $str_hide_strstatusnc?>><?php
      if ($strstatusnc != "")
      {
      $strstatusnc_look = substr($this->Db->qstr($strstatusnc), 1, -1); 
      $nmgp_def_dados = array(); 
