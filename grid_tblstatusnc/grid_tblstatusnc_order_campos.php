...
<?php
   ...
   $Ord_Cmp = new grid_tblstatusnc_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tblstatusnc_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["intstatusncid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['labels']["intstatusncid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['labels']["intstatusncid"] : "" . $this->Nm_lang['lang_tblstatusnc_fld_intstatusncid'] . "";
   $tab_ger_campos['strstatusnc'] = "on";
   $tab_def_campos['strstatusnc'] = "strstatusnc";
   $tab_converte["strstatusnc"]   = "strstatusnc";
   $tab_labels["strstatusnc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['labels']["strstatusnc"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['labels']["strstatusnc"] : "" . $this->Nm_lang['lang_tblstatusnc_fld_strstatusnc'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tblstatusnc_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tblstatusnc']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
