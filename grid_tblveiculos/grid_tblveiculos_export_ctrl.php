<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tblveiculos']['sc_process_barr'] = true;
require_once('../grid_tblveiculos/index.php');
unset($_SESSION['scriptcase']['grid_tblveiculos']['sc_process_barr']);
$ExportCtrl = new grid_tblveiculos_export_control;
$ExportCtrl->Export_barr();

class grid_tblveiculos_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_tblveiculos'] ?> :: Excel</TITLE>
