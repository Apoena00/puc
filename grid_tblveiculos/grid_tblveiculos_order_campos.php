...
<?php
   ...
   $Ord_Cmp = new grid_tblveiculos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tblveiculos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['strveiculo'] = "strveiculo";
   $tab_converte["strveiculo"]   = "strveiculo";
   $tab_labels["strveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["strveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["strveiculo"] : "" . $this->Nm_lang['lang_tblveiculos_fld_strveiculo'] . "";
   $tab_ger_campos['dtalancamento'] = "on";
   $tab_def_campos['dtalancamento'] = "dtalancamento";
   $tab_converte["dtalancamento"]   = "dtalancamento";
   $tab_labels["dtalancamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["dtalancamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["dtalancamento"] : "" . $this->Nm_lang['lang_tblveiculos_fld_dtalancamento'] . "";
   $tab_ger_campos['strcaracteristicas'] = "on";
   $tab_def_campos['strcaracteristicas'] = "strcaracteristicas";
   $tab_converte["strcaracteristicas"]   = "strcaracteristicas";
   $tab_labels["strcaracteristicas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["strcaracteristicas"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["strcaracteristicas"] : "" . $this->Nm_lang['lang_tblveiculos_fld_strcaracteristicas'] . "";
   $tab_ger_campos['imgveiculo'] = "on";
   $tab_def_campos['imgveiculo'] = "imgveiculo";
   $tab_converte["imgveiculo"]   = "imgveiculo";
   $tab_labels["imgveiculo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["imgveiculo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["imgveiculo"] : "" . $this->Nm_lang['lang_tblveiculos_fld_imgveiculo'] . "";
   $tab_ger_campos['bolforalinha'] = "on";
   $tab_def_campos['bolforalinha'] = "bolforalinha";
   $tab_converte["bolforalinha"]   = "bolforalinha";
   $tab_labels["bolforalinha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["bolforalinha"])) ? $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['labels']["bolforalinha"] : "" . $this->Nm_lang['lang_tblveiculos_fld_bolforalinha'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tblveiculos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tblveiculos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
