...
//
   ...
   $_SESSION['scriptcase']['login']['glo_nm_perfil']          = "tcc_puc";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['login']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc', 1, true);
    }
    else {
...
//
    ...
    else
    {
        ...
        if (isset($_POST["twitter_user"])) 
        {
            ...
            nm_limpa_str_login($_SESSION['twitter_user']);
        }
        ...
        if (isset($_POST["twitter_email"])) 
        {
            ...
            nm_limpa_str_login($_SESSION['twitter_email']);
        }
        ...
        if (isset($_POST["twitter_name"])) 
        {
            ...
            nm_limpa_str_login($_SESSION['twitter_name']);
        }
...
//
    ...
    function ajax_login_validate_links($links, $script_case_init)
    {
        ...
        //register_shutdown_function("login_pack_ajax_response");
        $inicial_login->contr_login->NM_ajax_flag          = true;
        $inicial_login->contr_login->NM_ajax_opcao         = 'validate_links';
        $inicial_login->contr_login->NM_ajax_info['param'] = array(
