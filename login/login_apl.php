...
$_SESSION['scriptcase']['login']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['login']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['login']['label'] = "Login - SGQ - Sistema de Gerenciamento de Qualidade";
...
$_SESSION['scriptcase']['login']['contr_erro'] = 'off'; 
    ...
    function ValidateField_pswd(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['login']['php_cmp_required']['pswd'] == "on")) 
      { 
          if ($this->pswd == "")  
          { 
              $hasError = true;
...
$_SESSION['scriptcase']['login']['contr_erro'] = 'off'; 
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['empty_filter']);
      ...
      $sv_data = $data_search;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_login = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['login']['total'] = $qt_geral_reg_login;
      $_SESSION['sc_session'][$this->Ini->sc_page]['login']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['login']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['login']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['login']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['login']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['login']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          login_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['login']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
