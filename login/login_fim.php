...
//----- 
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['login']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['login']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   if ((isset($nmgp_parms) && $nmgp_parms == "glo_menu") || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['login']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['login']['sc_modal'])
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['login']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['login']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['login']['lig_iframe_modal']);
               }
               else
               {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['login']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['login']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['login']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
