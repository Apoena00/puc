...
//
   ...
   $_SESSION['scriptcase']['login_mob']['glo_nm_perfil']          = "tcc_puc";
   $_SESSION['scriptcase']['login_mob']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['login_mob']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['login_mob']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['login_mob']['glo_nm_path_doc']        = "";
   $NM_dir_atual = getcwd();
...
// 
      ...
      if (isset($_SESSION['scriptcase']['login_mob']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['login_mob']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['login_mob']['actual_lang']) || $_SESSION['scriptcase']['login_mob']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['login_mob']['actual_lang'] = $this->str_lang;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_login_mob->contr_login_mob->NM_ajax_info['redir']['action']  = $nm_apl_dest;
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['login_mob']['session_timeout']['redir'])) {
...
';
          ...
          if ($_SESSION['scriptcase']['login_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['login_mob']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['login_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['login_mob']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['login_mob']['session_timeout']);
      ...
      {
          $inicial_login_mob->contr_login_mob->NM_ajax_info['redir']['action']  = "login_mob.php";
          $inicial_login_mob->contr_login_mob->NM_ajax_info['redir']['target']  = "_self";
          $inicial_login_mob->contr_login_mob->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_login_mob->contr_login_mob->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          $inicial_login_mob->contr_login_mob->NM_ajax_info['redir']['script_case_session']  = session_id();
          login_mob_pack_ajax_response();
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['login_mob']['session_timeout']['redir']))
      {
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['login_mob']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["login_mob"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["login_mob"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
...
// 
   ...
   function init2()
   {
      if (isset($_SESSION['sc_session'][$this->sc_page]['login_mob']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['login_mob']['initialize'])  
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['initialize'] = false;
      } 
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['login_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['login_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['login_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['login_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc', 1, true);
    }
    else {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['login_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['login_mob']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['login_mob']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['login_mob']['SC_sep_date1'];
           }
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        if (is_file($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt"));
            if (isset($apl_def[0]) && $apl_def[0] != "login") {
            ...
            if (is_file($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
                $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['login']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
                $_SESSION['scriptcase']['login']['session_timeout']['lang'] = $lang_atu;
            }
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['login_mob']['session_timeout']['redir']))
    {
        ...
        if ('ajax_login_mob_validate_pswd' == $_POST['rs'])
        {
            $pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_login_mob_validate_links' == $_POST['rs'])
        {
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['login_mob']['parms']))
    {
        ...
        {
            $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['login_mob']['parms']);
            $todo  = explode("?@?", $todox);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
    ...
    else
    {
        ...
        if (isset($_POST["facebook_error_code"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['facebook_error_code']);
        }
        ...
        if (isset($_POST["facebook_error_msg"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['facebook_error_msg']);
        }
        ...
        if (isset($_POST["facebook_user"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['facebook_user']);
        }
        ...
        if (isset($_POST["facebook_email"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['facebook_email']);
        }
        ...
        if (isset($_POST["google_user"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['google_user']);
        }
        ...
        if (isset($_POST["google_email"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['google_email']);
        }
        ...
        if (isset($_POST["logged_date_login"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['logged_date_login']);
        }
        ...
        if (isset($_POST["usr_email"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['usr_email']);
        }
        ...
        if (isset($_POST["twitter_user"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['twitter_user']);
        }
        ...
        if (isset($_POST["twitter_email"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['twitter_email']);
        }
        ...
        if (isset($_POST["usr_login"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['usr_login']);
        }
        ...
        if (isset($_POST["google_error_code"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['google_error_code']);
        }
        ...
        if (isset($_POST["google_error_msg"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['google_error_msg']);
        }
        ...
        if (isset($_POST["facebook_name"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['facebook_name']);
        }
        ...
        if (isset($_POST["google_name"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['google_name']);
        }
        ...
        if (isset($_POST["twitter_name"])) 
        {
            ...
            nm_limpa_str_login_mob($_SESSION['twitter_name']);
        }
    ...
    sajax_export("ajax_login_mob_validate_pswd");
    sajax_export("ajax_login_mob_validate_links");
...
//
    ...
    function ajax_login_mob_validate_pswd($pswd, $script_case_init)
    {
        global $inicial_login_mob;
        //register_shutdown_function("login_mob_pack_ajax_response");
        $inicial_login_mob->contr_login_mob->NM_ajax_flag          = true;
        $inicial_login_mob->contr_login_mob->NM_ajax_opcao         = 'validate_pswd';
        $inicial_login_mob->contr_login_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_login_mob_validate_links($links, $script_case_init)
    {
        global $inicial_login_mob;
        //register_shutdown_function("login_mob_pack_ajax_response");
        $inicial_login_mob->contr_login_mob->NM_ajax_flag          = true;
        $inicial_login_mob->contr_login_mob->NM_ajax_opcao         = 'validate_links';
        $inicial_login_mob->contr_login_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_login_mob_submit_form($login, $pswd, $links, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_login_mob;
        //register_shutdown_function("login_mob_pack_ajax_response");
        $inicial_login_mob->contr_login_mob->NM_ajax_flag          = true;
...
//-----
      {
         ...
         if (isset($inicial_login_mob->contr_login_mob->NM_ajax_info['varList']) && !empty($inicial_login_mob->contr_login_mob->NM_ajax_info['varList']))
         {
            login_mob_pack_var_list($aResp);
         }
         ...
         if (isset($inicial_login_mob->contr_login_mob->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_login_mob->contr_login_mob->NM_ajax_info['buttonDisplayVert']))
         {
            login_mob_pack_ajax_button_display_vert($aResp);
         }
         ...
         if (isset($inicial_login_mob->contr_login_mob->NM_ajax_info['event_field']) && '' != $inicial_login_mob->contr_login_mob->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_login_mob->contr_login_mob->NM_ajax_info['event_field'];
         }
         else
         {
   ...
   function login_mob_pack_var_list(&$aResp)
   {
      global $inicial_login_mob;
      foreach ($inicial_login_mob->contr_login_mob->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // login_mob_pack_var_list
   ...
   {
      global $inicial_login_mob;
      $aResp['ajaxAlert'] = array('message' => $inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxAlert']['message'], 'params' =>  $inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxAlert']['params']);
   ...
   function login_mob_pack_ajax_message(&$aResp)
   {
      ...
      $aResp['ajaxMessage'] = array('message'      => login_mob_pack_protect_string($inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['message']),
                                    ...
                                    'toast'        => isset($inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['toast'])        ? $inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['toast']        : 'N',
                                    'toast_pos'    => isset($inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['toast_pos'])    ? $inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['toast_pos']    : '',
                                    'type'         => isset($inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['type'])         ? $inicial_login_mob->contr_login_mob->NM_ajax_info['ajaxMessage']['type']         : '',
   ...
   function login_mob_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_login_mob;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_login_mob->contr_login_mob->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
