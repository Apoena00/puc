...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate pswd
  function do_ajax_login_mob_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_mob_validate_pswd(var_pswd, var_script_case_init, do_ajax_login_mob_validate_pswd_cb);
  } // do_ajax_login_mob_validate_pswd

  function do_ajax_login_mob_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_mob_validate_pswd_cb

  // ---------- Validate usuario
  function do_ajax_login_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldHidden(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_login_mob_validate_usuario_cb);
  } // do_ajax_login_mob_validate_usuario

  function do_ajax_login_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_mob_validate_usuario_cb

  // ---------- Validate links
  function do_ajax_login_mob_validate_links()
  {
    var nomeCampo_links = "links";
    var var_links = scAjaxGetFieldText(nomeCampo_links);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_mob_validate_links(var_links, var_script_case_init, do_ajax_login_mob_validate_links_cb);
  } // do_ajax_login_mob_validate_links

  function do_ajax_login_mob_validate_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "links";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_mob_validate_links_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  function do_ajax_login_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_login_mob_submit_form(var_login, var_pswd, var_usuario, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_login_mob_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_login_mob_submit_form_cb_after_alert);
  } // do_ajax_login_mob_submit_form_cb
  function do_ajax_login_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_login_mob_submit_form_cb_after_alert
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['login_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_login_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_login_mob_navigate_form_cb_after_alert);
  } // do_ajax_login_mob_navigate_form_cb
  function do_ajax_login_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
?>
  ...
  } // do_ajax_login_mob_navigate_form_cb_after_alert
  function sc_hide_login_mob_form()
  {
