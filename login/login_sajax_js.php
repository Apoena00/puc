...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate pswd
  function do_ajax_login_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_pswd(var_pswd, var_script_case_init, do_ajax_login_validate_pswd_cb);
  } // do_ajax_login_validate_pswd

  function do_ajax_login_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
  ...
  function do_ajax_login_validate_links()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_links(var_links, var_script_case_init, do_ajax_login_validate_links_cb);
  } // do_ajax_login_validate_links

  function do_ajax_login_validate_links_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "links";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_links_cb
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_login_submit_form_cb_after_alert);
  } // do_ajax_login_submit_form_cb
  function do_ajax_login_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_login_submit_form_cb_after_alert
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['login']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_login_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_login_navigate_form_cb_after_alert);
  } // do_ajax_login_navigate_form_cb
  function do_ajax_login_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('login');
...
?>
  ...
  } // do_ajax_login_navigate_form_cb_after_alert
  function sc_hide_login_form()
  {
