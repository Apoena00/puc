<?php
   include_once('veiculos_json_problema_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil']          = "tcc_puc";
   $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class veiculos_json_problema_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "veiculos_json_problema"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/veiculos_json_problema';
      ...
      if (isset($_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['veiculos_json_problema']['actual_lang']) || $_SESSION['scriptcase']['veiculos_json_problema']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['veiculos_json_problema']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("veiculos_json_problema_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Link_View'] = true;
          }
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["veiculos_json_problema"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["veiculos_json_problema"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "veiculos_json_problema_erro.class.php"); 
      $this->Erro = new veiculos_json_problema_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('veiculos_json_problema'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao']) && $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil']) && $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['veiculos_json_problema']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao']))
      {
          ob_start();
      ...
      if (isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_conexao'], $this->root . $this->path_prod, 'tcc_puc'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['veiculos_json_problema']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class veiculos_json_problema_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new veiculos_json_problema_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['veiculos_json_problema']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['veiculos_json_problema']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['veiculos_json_problema']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['veiculos_json_problema'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['veiculos_json_problema']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['veiculos_json_problema']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('veiculos_json_problema') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['veiculos_json_problema']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['veiculos_json_problema']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['veiculos_json_problema']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['veiculos_json_problema']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "veiculos_json_problema_erro.class.php"); 
      $this->Erro      = new veiculos_json_problema_erro();
      $this->Erro->Ini = $this->Ini;
//
      $_SESSION['scriptcase']['veiculos_json_problema']['contr_erro'] = 'on';
  header_remove(); 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	$strveiculo = isset($_REQUEST['veiculo']) ? $_REQUEST['veiculo'] : '';
	$dtalancamento = isset($_REQUEST['data']) ? $_REQUEST['data'] : date('Y-m-d');
	$strcaracteristicas = isset($_REQUEST['caracteristica']) ? $_REQUEST['caracteristica'] : '';
	$imgveiculo = isset($_REQUEST['foto']) ? $_REQUEST['foto'] : '';
	$bolforalinha = isset($_REQUEST['foradelinha']) ? $_REQUEST['foradelinha'] : 0;

	$insert_table  = 'tblveiculos';     
	$insert_fields = array(   
		 'strveiculo' => "'$strveiculo'",
		 'dtalancamento' => "'$dtalancamento'",
		 'strcaracteristicas' => "'$strcaracteristicas'",
		 'imgveiculo' => "'$imgveiculo'",
		 'bolforalinha' => "$bolforalinha",
	 );
	...
	if  ( $strveiculo != '') 
	{
     ...
     $nm_select = $insert_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ;
		$this->json(array('message' => 'Registro inserido com sucesso.Id: ' . $insert_sql));
	 }

	if (!isset($_REQUEST['veiculo']))
	{
		$this->json(array('message' => 'Registro não inserido '));
	}
...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
	...
	$strcaracteristicas = isset($_REQUEST['caracteristica']) ? $_REQUEST['caracteristica'] : '';
	$imgveiculo = isset($_REQUEST['foto']) ? $_REQUEST['foto'] : '';
	$bolforalinha = isset($_REQUEST['foradelinha']) ? $_REQUEST['foradelinha'] : '';


	$update_table  = 'tblveiculos';      
	$update_where  = "intveiculoid = $id "; 
	$update_fields = array(   
		 'strveiculo' => "'$strveiculo'",
		 'dtalancamento' => "'$dtalancamento'",
		 'strcaracteristicas' => "'$strcaracteristicas'",
	...
	if  ( $strveiculo != '') 
	{
     ...
     $nm_select = $update_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ;
		$this->json(array('message' => 'Registro atualizado com sucesso.Id: ' . $update_sql));
	}
}
...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
	...
	$delete_sql = "DELETE FROM tblveiculos where intveiculoid = $id ";
	...
	if  ( $id != '') 
	{
     ...
     $nm_select = $delete_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ;
		$this->json(array('message' => 'Registro removido com sucesso.Id: ' . $id));
	}
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
	...
	$check_sql = "select intveiculoid, strveiculo, dtalancamento, strcaracteristicas, imgveiculo, bolforalinha from tblveiculos order by strveiculo ";
...
;
	...
	if (false == $this->rs )
	{
		$this->json(array('message' => 'Erro acessando o banco de dados.'));
	}
	else
	{
	while(!$this->rs->EOF)
	...
	$id = $this->rs->fields[0];
	$veiculo=$this->rs->fields[1];
	$data=$this->rs->fields[2];
	$caracteristica=$this->rs->fields[3];
	$foto=$this->rs->fields[4];
	$foradelinha = $this->rs->fields[5];	
...
$_SESSION['scriptcase']['veiculos_json_problema']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
$veiculo=$rs->fields[1];
$data=$rs->fields[2];
$caracteristica=$rs->fields[3];
$foto=$rs->fields[4];
$foradelinha = $rs->fields[5];	
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_veiculos_json_problema($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       if (is_file($root . $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp'] . "/sc_apl_default_tcc_puc.txt"));
           if (isset($apl_def[0]) && $apl_def[0] != "veiculos_json_problema") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (is_file($root . $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
               $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['veiculos_json_problema']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
               $_SESSION['scriptcase']['veiculos_json_problema']['session_timeout']['lang'] = $lang_atu;
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "veiculos_json_problema";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'veiculos_json_problema' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('veiculos_json_problema' == $sReferer || 'veiculos_json_problema_' == substr($sReferer, 0, 23))
       {
           $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'veiculos_json_problema')
   {
       $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['veiculos_json_problema']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/veiculos_json_problema_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_veiculos_json_problema($cadapar[1]);
   ...
   $contr_veiculos_json_problema = new veiculos_json_problema_apl();
   $contr_veiculos_json_problema->controle();
//
   function nm_limpa_str_veiculos_json_problema(&$str)
   {
